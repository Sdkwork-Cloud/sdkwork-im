# Im Adapter Rtc Tencent Component Specs

This directory is the local standards index for `im-adapter-rtc-tencent`.
...
| Field | Value |
| --- | --- |
| Name | `im-adapter-rtc-tencent` |
| Type | `rust-crate` |
| Root | `craw-chat/adapters/rtc-tencent` |
...
- `cargo test --manifest-path apps/craw-chat/adapters/rtc-tencent/Cargo.toml`
