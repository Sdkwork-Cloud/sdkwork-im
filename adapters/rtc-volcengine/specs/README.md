# Im Adapter Rtc Volcengine Component Specs

This directory is the local standards index for `im-adapter-rtc-volcengine`.
...
| Field | Value |
| --- | --- |
| Name | `im-adapter-rtc-volcengine` |
| Type | `rust-crate` |
| Root | `craw-chat/adapters/rtc-volcengine` |
...
- `cargo test --manifest-path apps/craw-chat/adapters/rtc-volcengine/Cargo.toml`
