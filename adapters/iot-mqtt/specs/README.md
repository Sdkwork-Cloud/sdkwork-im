# Im Adapter Iot Mqtt Component Specs

This directory is the local standards index for `im-adapter-iot-mqtt`.
...
| Field | Value |
| --- | --- |
| Name | `im-adapter-iot-mqtt` |
| Type | `rust-crate` |
| Root | `craw-chat/adapters/iot-mqtt` |
