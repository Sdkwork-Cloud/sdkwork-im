# Im Adapter Iot Access Local Component Specs

This directory is the local standards index for `im-adapter-iot-access-local`.
...
| Field | Value |
| --- | --- |
| Name | `im-adapter-iot-access-local` |
| Type | `rust-crate` |
| Root | `craw-chat/adapters/iot-access-local` |
