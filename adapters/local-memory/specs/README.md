# Im Adapters Local Memory Component Specs

This directory is the local standards index for `im-adapters-local-memory`.
...
| Field | Value |
| --- | --- |
| Name | `im-adapters-local-memory` |
| Type | `rust-crate` |
| Root | `sdkwork-im/adapters/local-memory` |
