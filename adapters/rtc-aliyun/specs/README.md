# Im Adapter Rtc Aliyun Component Specs

This directory is the local standards index for `im-adapter-rtc-aliyun`.
...
| Field | Value |
| --- | --- |
| Name | `im-adapter-rtc-aliyun` |
| Type | `rust-crate` |
| Root | `craw-chat/adapters/rtc-aliyun` |
...
- `cargo test --manifest-path apps/craw-chat/adapters/rtc-aliyun/Cargo.toml`
