...
fn test_file_checkpoint_store_recovers_pending_tmp_file_on_reopen() {
    ...
    let pending_payload = BTreeMap::from([(
        "6:t_demo|7:default|4:user|6:u_demo|5:d_pad".to_string(),
    ...
    let restored = reopened
        .load_checkpoint("t_demo", "default", "user", "u_demo", "d_pad")
...
fn test_file_realtime_event_window_store_persists_and_trims_across_reopen() {
    ...
    let restored = reopened
        .load_window("t_demo", "default", "user", "u_demo", "d_pad")
    ...
    reopened
        .trim_window("t_demo", "default", "user", "u_demo", "d_pad", 1)
    ...
    assert!(
        reopened
            .clear_window("t_demo", "default", "user", "u_demo", "d_pad")
...
fn test_file_checkpoint_store_persists_checkpoint_batch_across_reopen() {
    ...
    assert_eq!(
        reopened
            .load_checkpoint("t_demo", "default", "user", "u_demo", "d_phone")
...
fn test_file_disconnect_fence_store_persists_and_clears_across_reopen() {
    ...
    let restored = reopened
        .load_fence("t_demo", "default", "user", "u_demo", "d_pad")
        .expect("load should succeed")
    ...
    assert!(
        reopened
            .clear_fence("t_demo", "default", "user", "u_demo", "d_pad")
...
fn test_file_subscription_store_persists_across_reopen() {
    ...
    assert!(
        reopened
            .clear_subscriptions("t_demo", "default", "user", "u_demo", "d_pad")
            .expect("clear should succeed")
    );
...
fn test_file_presence_state_store_persists_across_reopen() {
    ...
    let restored = reopened
        .load_state("t_demo", "default", "user", "u_demo", "d_pad")
        .expect("load should succeed")
    ...
    let listed = reopened
        .list_states_for_principal("t_demo", "default", "user", "u_demo")
        .expect("list should succeed");
