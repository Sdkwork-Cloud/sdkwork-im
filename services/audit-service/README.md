...
This README is the SDKWork module entrypoint for `audit-service`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
...
- `cargo test --manifest-path apps/sdkwork-im/services/audit-service/Cargo.toml`
