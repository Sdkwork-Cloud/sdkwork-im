...
pub use embedded_session_gateway::{
    bootstrap_embedded_session_gateway_runtime, EmbeddedSessionGatewayRuntime,
};
...
const GATEWAY_UPSTREAM_TIMEOUT_SECONDS_ENV: &str = "SDKWORK_IM_GATEWAY_UPSTREAM_TIMEOUT_SECONDS";
const GATEWAY_UPSTREAM_TIMEOUT_SECONDS_DEFAULT: u64 = 60;
const GATEWAY_UPSTREAM_TIMEOUT_SECONDS_MAX: u64 = 300;
const GATEWAY_MAX_UPSTREAM_RESPONSE_BODY_BYTES_ENV: &str =
    "SDKWORK_IM_GATEWAY_MAX_UPSTREAM_RESPONSE_BODY_BYTES";
const GATEWAY_MAX_UPSTREAM_RESPONSE_BODY_BYTES_DEFAULT: usize = 20 * 1024 * 1024;
const GATEWAY_MAX_UPSTREAM_RESPONSE_BODY_BYTES_MAX: usize = 100 * 1024 * 1024;
...
fn resolve_max_upstream_response_body_bytes() -> usize {
...
fn build_gateway_upstream_client() -> Client {
    Client::builder()
