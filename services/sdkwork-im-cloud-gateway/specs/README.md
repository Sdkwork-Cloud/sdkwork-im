# Web Gateway Component Specs

This directory is the local standards index for `sdkwork-im-cloud-gateway`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-im-cloud-gateway` |
| Type | `rust-crate` |
| Root | `sdkwork-im/services/sdkwork-im-cloud-gateway` |
...
- `cargo test --manifest-path apps/sdkwork-im/services/sdkwork-im-cloud-gateway/Cargo.toml`
