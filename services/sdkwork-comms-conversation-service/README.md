...
This README is the SDKWork module entrypoint for `sdkwork-comms-conversation-service`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
...
- `cargo test -p sdkwork-comms-conversation-service`
