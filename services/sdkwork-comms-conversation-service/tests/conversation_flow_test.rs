...
fn test_message_history_window_rejects_invalid_limit_at_runtime_boundary() {
    ...
    for invalid_limit in [0, 1001] {
        let result = runtime.list_messages_window("t_demo", "default", "c_history_limit_guard",
            "u_owner",
            None,
            invalid_limit,
        );
...
fn test_create_conversation_does_not_leak_state_when_batch_commit_fails() {
    ...
    assert!(matches!(
        runtime.list_members("t_demo", "default", "c_group_create_batch_fail"),
    ...
    let members = runtime
        .list_members("t_demo", "default", "c_group_create_batch_fail")
...
fn test_bind_direct_chat_does_not_leak_state_when_batch_commit_fails() {
    ...
    assert!(matches!(
        runtime.list_members("t_demo", "default", "c_direct_batch_fail"),
        Err(RuntimeError::ConversationNotFound(conversation_id))
            if conversation_id == "c_direct_batch_fail"
    ));
    assert!(matches!(
        runtime.conversation_business_binding("t_demo", "default", "c_direct_batch_fail"),
        Err(RuntimeError::ConversationNotFound(conversation_id))
            if conversation_id == "c_direct_batch_fail"
    ));
    assert!(
    ...
    let binding = runtime
        .conversation_business_binding("t_demo", "default", "c_direct_batch_fail")
    ...
    let members = runtime
        .list_members("t_demo", "default", "c_direct_batch_fail")
...
fn test_create_thread_does_not_leak_state_when_batch_commit_fails() {
    ...
    assert!(matches!(
        runtime.list_members("t_demo", "default", "c_thread_batch_fail"),
        Err(RuntimeError::ConversationNotFound(conversation_id))
            if conversation_id == "c_thread_batch_fail"
    ));
    assert!(matches!(
        runtime.conversation_business_binding("t_demo", "default", "c_thread_batch_fail"),
        Err(RuntimeError::ConversationNotFound(conversation_id))
            if conversation_id == "c_thread_batch_fail"
    ));
    assert_eq!(
    ...
    let binding = runtime
        .conversation_business_binding("t_demo", "default", "c_thread_batch_fail")
    ...
    let members = runtime
        .list_members("t_demo", "default", "c_thread_batch_fail")
...
fn test_duplicate_create_conversation_is_idempotent_and_conflicting_retry_is_rejected() {
    ...
    let members = runtime
        .list_members("t_demo", "default", "c_create_retry")
...
fn test_runtime_replays_recorded_conversation_events_after_rebuild() {
    ...
    let members = replay_runtime
        .list_members("t_demo", "default", "c_replay")
...
fn test_create_agent_dialog_creates_requester_and_agent_members() {
    ...
    let members = runtime
        .list_members("t_demo", "default", "c_agent_dialog")
...
fn test_create_system_channel_creates_system_and_subscriber_members() {
    ...
    let members = runtime
        .list_members("t_demo", "default", "c_system_channel")
    ...
    let cursor = runtime
        .read_cursor_view("t_demo", "default", "c_system_channel", "u_demo")
...
fn test_create_agent_handoff_creates_source_agent_and_target_members() {
    ...
    let members = runtime
        .list_members("t_demo", "default", "c_agent_handoff")
    ...
    let cursor = runtime
        .read_cursor_view("t_demo", "default", "c_agent_handoff", "u_demo")
...
fn test_agent_handoff_accept_resolve_close_state_machine_and_closed_handoff_rejects_posts() {
    ...
    let opened = runtime
        .get_agent_handoff_state("t_demo", "default", "c_agent_handoff_state", "ag_source")
...
fn test_conversation_membership_lifecycle_tracks_creator_and_member_changes() {
    ...
    let members = runtime
        .list_members("t_demo", "default", "c_members")
...
fn test_conversation_membership_allows_same_actor_id_with_different_principal_kind() {
    ...
    let members = runtime
        .list_members("t_demo", "default", "c_members_typed_principal")
        .expect("list members should succeed");
...
fn test_read_cursor_unread_count_excludes_messages_sent_by_current_principal() {
    ...
    let owner_cursor_after_own_message = runtime
        .read_cursor_view("t_demo", "default", "c_received_unread_only", "u_owner")
    ...
    let friend_cursor_after_owner_message = runtime
        .read_cursor_view("t_demo", "default", "c_received_unread_only", "u_friend")
...
fn test_conversation_bound_write_capability_gate_rejects_actor_kind_mismatch() {
    ...
    let gate_attempt = runtime.ensure_conversation_bound_write_allowed_with_actor_kind("t_demo", "default", "c_write_capability_actor_kind_guard",
        "u_owner",
        "agent",
        "stream.append",
    );
...
fn test_governance_writes_reject_actor_kind_mismatch() {
    ...
    let members = runtime
        .list_members("t_demo", "default", "c_group_actor_kind_governance")
        .expect("list members should succeed");
...
fn test_add_member_does_not_leak_membership_when_journal_append_fails() {
    ...
    let members = runtime
        .list_members("t_demo", "default", "c_group_add_commit_fail")
...
fn test_remove_member_does_not_leak_removed_state_when_journal_append_fails() {
    ...
    let members = runtime
        .list_members("t_demo", "default", "c_group_remove_commit_fail")
        .expect("list members should still succeed");
...
fn test_leave_conversation_does_not_leak_left_state_when_journal_append_fails() {
    ...
    let members = runtime
        .list_members("t_demo", "default", "c_group_leave_commit_fail")
        .expect("list members should still succeed");
...
fn test_transfer_owner_does_not_leak_role_swap_when_journal_append_fails() {
    ...
    let members = runtime
        .list_members("t_demo", "default", "c_group_transfer_commit_fail")
        .expect("list members should still succeed");
    let owner = members
        .iter()
...
fn test_role_change_does_not_leak_updated_role_when_journal_append_fails() {
    ...
    let members = runtime
        .list_members("t_demo", "default", "c_group_role_commit_fail")
        .expect("list members should still succeed");
    let member_state = members
        .iter()
...
fn test_read_cursor_does_not_advance_when_journal_append_fails() {
    ...
    let cursor = runtime
        .read_cursor_view("t_demo", "default", "c_group_cursor_commit_fail", "u_owner")
...
fn test_group_member_can_leave_and_loses_access() {
    ...
    let members = runtime
        .list_members("t_demo", "default", "c_group_leave")
        .expect("list members should succeed");
    assert_eq!(members.len(), 1);
    assert_eq!(members[0].principal_id, "u_owner");
...
fn test_group_owner_can_transfer_ownership_and_then_leave() {
    ...
    let members = runtime
        .list_members("t_demo", "default", "c_group_transfer_owner")
        .expect("list members should succeed");
    assert_eq!(members.len(), 1);
...
fn test_group_owner_can_change_non_owner_member_roles() {
    ...
    let members = runtime
        .list_members("t_demo", "default", "c_group_role_change")
        .expect("list members should succeed");
    let target = members
        .into_iter()
        .find(|item| item.principal_id == "u_member")
...
fn test_stale_member_id_cannot_change_rejoined_member_role() {
    ...
    let members = runtime
        .list_members("t_demo", "default", "c_group_role_change_rejoin_guard")
        .expect("list members should succeed");
    let target = members
        .into_iter()
        .find(|item| item.principal_id == "u_member")
...
fn test_left_member_rejoin_creates_new_membership_episode() {
    ...
    let view = runtime
        .read_cursor_view("t_demo", "default", "c_group_rejoin", "u_member")
...
fn test_stale_member_id_cannot_remove_rejoined_active_member() {
    ...
    let members = runtime
        .list_members("t_demo", "default", "c_group_rejoin_remove_guard")
        .expect("list members should succeed");
    assert_eq!(members.len(), 2);
    assert!(
        members
...
fn test_bind_direct_chat_conversation_creates_business_bound_direct_runtime() {
    ...
    let binding = runtime
        .conversation_business_binding("t_demo", "default", "c_direct_binding")
    ...
    let members = runtime
        .list_members("t_demo", "default", "c_direct_binding")
...
fn test_create_thread_conversation_binds_parent_message_runtime_and_survives_recovery_replay() {
    ...
    let binding = runtime
        .conversation_business_binding("t_demo", "default", "c_thread_runtime")
    ...
    let thread_members = runtime
        .list_members("t_demo", "default", "c_thread_runtime")
...
fn test_create_thread_conversation_auto_subscribes_root_message_author_for_notification_truth() {
    ...
    let thread_members = runtime
        .list_members("t_demo", "default", "c_thread_notify")
        .expect("thread members should be queryable");
    ...
    let read_cursor = runtime
        .read_cursor_view("t_demo", "default", "c_thread_notify", "u_root_author")
...
fn test_direct_chat_business_binding_survives_recovery_replay() {
    ...
    let binding = replay_runtime
        .conversation_business_binding("t_demo", "default", "c_direct_replay")
