# Conversation Runtime Component Specs

This directory is the local standards index for `sdkwork-comms-conversation-service`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-comms-conversation-service` |
| Type | `rust-crate` |
| Root | `sdkwork-im/services/sdkwork-comms-conversation-service` |
...
- `cargo test --manifest-path apps/sdkwork-im/services/sdkwork-comms-conversation-service/Cargo.toml`
