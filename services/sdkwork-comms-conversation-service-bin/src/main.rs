...
async fn run() -> Result<(), String> {
        ...
        .filter(|value| !value.is_empty())
    {
        Some(catalog_path) => {
            ...
            sdkwork_router_im_chat_open_api::build_public_app_with_principal_directory(Arc::new(directory))
        }
        None => {
            ...
            if allow_all {
                ...
                sdkwork_router_im_chat_open_api::build_public_app_with_allow_all_principals()
            } else {
                return Err(format!(
