...
fn test_im_commercial_gate_covers_strict_lints_and_exactly_once_regressions() {
    ...
    for required_command in [
        ...
        "cargo clippy -p sdkwork-comms-conversation-service -p governance-service --tests -- -D warnings",
        "cargo test -p sdkwork-comms-conversation-service --test conversation_flow_test test_duplicate_bind_direct_chat_conversation_is_idempotent_and_conflicting_retry_is_rejected -- --exact",
        "cargo test -p sdkwork-comms-conversation-service --test http_smoke_test test_duplicate_bind_direct_chat_conversation_request_is_idempotent_and_conflicting_retry_is_rejected_over_http -- --exact",
        "cargo test -p sdkwork-comms-conversation-service --test conversation_flow_test test_create_conversation_rejects_oversized_creator_attributes -- --exact",
        "cargo test -p sdkwork-comms-conversation-service --test http_smoke_test test_add_member_rejects_oversized_attributes_over_http -- --exact",
        "cargo test -p sdkwork-comms-conversation-service --test conversation_flow_test test_post_message_rejects_oversized_sender_metadata -- --exact",
        "cargo test -p sdkwork-comms-conversation-service --test conversation_flow_test test_post_message_rejects_oversized_render_hints -- --exact",
        ...
        "cargo test -p governance-service --test provider_registry_test test_control_plane_rejects_provider_policy_diff_with_reversed_version_range -- --exact",
        ...
        "cargo test -p governance-service --test governance_loop_test test_control_plane_rejects_empty_tenant_provider_bindings_query_without_polluting_ops_runtime -- --exact",
        "cargo test -p governance-service --test governance_loop_test test_control_plane_rejects_empty_tenant_provider_policy_write_without_mutating_ops_or_audit -- --exact",
        ...
        "cargo test -p governance-service --test governance_loop_test test_control_plane_rejects_oversized_tenant_provider_bindings_query_without_polluting_ops_runtime -- --exact",
        "cargo test -p governance-service --test governance_loop_test test_control_plane_rejects_oversized_tenant_provider_policy_write_without_mutating_ops_or_audit -- --exact",
        ...
        "cargo clippy --no-deps -p sdkwork-comms-conversation-service -p local-minimal-node --tests -- -D warnings",
