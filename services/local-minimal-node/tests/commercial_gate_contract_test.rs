...
fn test_im_commercial_gate_covers_strict_lints_and_exactly_once_regressions() {
    ...
    for required_command in [
        ...
        "cargo test -p projection-service --test http_smoke_test test_device_registration_rejects_same_device_id_with_different_principal_over_http -- --exact",
        "cargo test -p projection-service --test http_smoke_test test_device_sync_feed_isolated_by_actor_kind_over_http -- --exact",
        "cargo test --manifest-path D:/sdkwork-opensource/sdkwork-rtc/Cargo.toml -p sdkwork-rtc-signaling-service --tests",
        ...
        "cargo test --manifest-path D:/sdkwork-opensource/sdkwork-rtc/Cargo.toml -p sdkwork-rtc-signaling-service --test http_smoke_test test_duplicate_rtc_session_create_is_idempotent_and_conflicting_retry_is_rejected -- --exact",
        "cargo test --manifest-path D:/sdkwork-opensource/sdkwork-rtc/Cargo.toml -p sdkwork-rtc-signaling-service --test http_smoke_test test_duplicate_rtc_session_create_with_same_actor_id_but_different_actor_kind_is_conflict -- --exact",
        "cargo test --manifest-path D:/sdkwork-opensource/sdkwork-rtc/Cargo.toml -p sdkwork-rtc-signaling-service --test http_smoke_test test_map_rtc_provider_callback_rejects_oversized_payload_json_over_http -- --exact",
        ...
        "cargo clippy --manifest-path D:/sdkwork-opensource/sdkwork-rtc/Cargo.toml --no-deps -p sdkwork-rtc-signaling-service --tests -- -D warnings",
    ] {
        assert!(
