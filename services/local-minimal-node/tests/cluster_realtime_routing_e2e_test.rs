...
async fn test_local_minimal_profile_records_remote_realtime_delivery_failure_without_failing_committed_message()
 {
    ...
    let add_member = app_a
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri("/api/v1/conversations/c_cluster_realtime_failure/members/add")
                .header("x-tenant-id", "t_demo")
                .header("x-user-id", "u_demo")
                .header("x-actor-kind", "user")
                .header("x-device-id", "d_owner")
    ...
    let register_remote_device = app_b
        ...
        .oneshot(
            Request::builder()
                ...
                .header("x-user-id", "u_other_demo")
                .header("x-actor-kind", "user")
                .header("x-device-id", "d_remote_failure")
                .header("x-session-id", "s_remote_failure")
                .header("content-type", "application/json")
                .body(Body::from(r#"{}"#))
                .unwrap(),
        )
    ...
    let post_message = app_a
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri("/api/v1/conversations/c_cluster_realtime_failure/messages")
                .header("x-tenant-id", "t_demo")
                .header("x-user-id", "u_demo")
                .header("x-actor-kind", "user")
                .header("x-device-id", "d_owner")
...
async fn test_local_minimal_profile_retries_pending_realtime_outbox_after_delivery_store_recovers()
{
    ...
    let add_member = app_a
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri("/api/v1/conversations/c_cluster_realtime_outbox_retry/members/add")
                .header("x-tenant-id", "t_demo")
                .header("x-user-id", "u_demo")
                .header("x-actor-kind", "user")
                .header("x-device-id", "d_owner")
    ...
    let register_remote_device = app_b
        ...
        .oneshot(
            Request::builder()
                ...
                .header("x-user-id", "u_other_demo")
                .header("x-actor-kind", "user")
                .header("x-device-id", "d_remote_retry")
                .header("x-session-id", "s_remote_retry")
                .header("content-type", "application/json")
                .body(Body::from(r#"{}"#))
                .unwrap(),
        )
    ...
    let first_post = app_a
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri("/api/v1/conversations/c_cluster_realtime_outbox_retry/messages")
                .header("x-tenant-id", "t_demo")
                .header("x-user-id", "u_demo")
                .header("x-actor-kind", "user")
                .header("x-device-id", "d_owner")
...
async fn test_local_minimal_profile_persists_pending_realtime_outbox_across_runtime_restart() {
    ...
    let add_member = app_a_before
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri("/api/v1/conversations/c_outbox_runtime_restart/members/add")
                .header("x-tenant-id", "t_demo")
                .header("x-user-id", "u_demo")
                .header("x-actor-kind", "user")
                .header("x-device-id", "d_owner")
    ...
    let register_remote_device = app_b
        ...
        .oneshot(
            Request::builder()
                ...
                .header("x-user-id", "u_other_demo")
                .header("x-actor-kind", "user")
                .header("x-device-id", "d_remote_restart")
                .header("x-session-id", "s_remote_restart")
                .header("content-type", "application/json")
                .body(Body::from(r#"{}"#))
                .unwrap(),
        )
    ...
    let first_post = app_a_before
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri("/api/v1/conversations/c_outbox_runtime_restart/messages")
                .header("x-tenant-id", "t_demo")
                .header("x-user-id", "u_demo")
                .header("x-actor-kind", "user")
                .header("x-device-id", "d_owner")
...
async fn test_local_minimal_profile_continues_realtime_fanout_after_one_target_fails() {
    ...
    for principal_id in ["u_a_fail", "u_z_ok"] {
        let add_member = app_a
            ...
            .oneshot(
                Request::builder()
                    .method("POST")
                    .uri("/api/v1/conversations/c_cluster_partial_realtime_failure/members/add")
                    .header("x-tenant-id", "t_demo")
                    .header("x-user-id", "u_demo")
                    .header("x-actor-kind", "user")
                    .header("x-device-id", "d_owner")
    ...
    let register_failing_device = app_b
        ...
        .oneshot(
            Request::builder()
                ...
                .uri("/api/v1/devices/register")
                .header("x-tenant-id", "t_demo")
                .header("x-user-id", "u_a_fail")
                .header("x-actor-kind", "user")
                .header("x-device-id", "d_fail")
                .header("x-session-id", "s_fail")
                .header("content-type", "application/json")
                .body(Body::from(r#"{}"#))
                .unwrap(),
        )
    ...
    let register_healthy_device = app_c
        ...
        .oneshot(
            Request::builder()
                ...
                .uri("/api/v1/devices/register")
                .header("x-tenant-id", "t_demo")
                .header("x-user-id", "u_z_ok")
                .header("x-actor-kind", "user")
                .header("x-device-id", "d_ok")
                .header("x-session-id", "s_ok")
                .header("content-type", "application/json")
                .body(Body::from(r#"{}"#))
                .unwrap(),
        )
    ...
    let post_message = app_a
        .oneshot(
            Request::builder()
                .method("POST")
                .uri("/api/v1/conversations/c_cluster_partial_realtime_failure/messages")
                .header("x-tenant-id", "t_demo")
                .header("x-user-id", "u_demo")
                .header("x-actor-kind", "user")
                .header("x-device-id", "d_owner")
