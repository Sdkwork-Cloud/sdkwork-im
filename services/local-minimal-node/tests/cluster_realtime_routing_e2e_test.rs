    ...
    let register_remote_device = app_b
        ...
        .oneshot(
            Request::builder()
                ...
                .header("x-sdkwork-user-id", "u_other_demo")
                .header("x-sdkwork-actor-kind", "user")
                .header("x-sdkwork-device-id", "d_remote_failure")
                .header("x-sdkwork-session-id", "s_remote_failure")
                .header("content-type", "application/json")
                .body(Body::from(r#"{}"#))
                .unwrap(),
        )
    ...
    let register_remote_device = app_b
        ...
        .oneshot(
            Request::builder()
                ...
                .header("x-sdkwork-user-id", "u_other_demo")
                .header("x-sdkwork-actor-kind", "user")
                .header("x-sdkwork-device-id", "d_remote_retry")
                .header("x-sdkwork-session-id", "s_remote_retry")
                .header("content-type", "application/json")
                .body(Body::from(r#"{}"#))
                .unwrap(),
        )
    ...
    let register_remote_device = app_b
        ...
        .oneshot(
            Request::builder()
                ...
                .header("x-sdkwork-user-id", "u_other_demo")
                .header("x-sdkwork-actor-kind", "user")
                .header("x-sdkwork-device-id", "d_remote_restart")
                .header("x-sdkwork-session-id", "s_remote_restart")
                .header("content-type", "application/json")
                .body(Body::from(r#"{}"#))
                .unwrap(),
        )
    ...
    let register_failing_device = app_b
        ...
        .oneshot(
            Request::builder()
                ...
                .header("x-sdkwork-actor-kind", "user")
                .header("x-sdkwork-device-id", "d_fail")
                .header("x-sdkwork-session-id", "s_fail")
                .header("content-type", "application/json")
                .body(Body::from(r#"{}"#))
                .unwrap(),
        )
    ...
    let register_healthy_device = app_c
        ...
        .oneshot(
            Request::builder()
                ...
                .header("x-sdkwork-actor-kind", "user")
                .header("x-sdkwork-device-id", "d_ok")
                .header("x-sdkwork-session-id", "s_ok")
                .header("content-type", "application/json")
                .body(Body::from(r#"{}"#))
                .unwrap(),
        )
