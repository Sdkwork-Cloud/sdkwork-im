    ...
    let response = strict_app
        .oneshot(
            Request::builder()
                ...
                .uri("/im/v3/api/chat/conversations/c_strict_restart_timeline/messages")
                .with_dual_token_tenant("t_demo")
                .with_dual_token_user("u_missing")
                .with_dual_token_actor_kind("user")
                .body(Body::empty())
                .unwrap(),
        )
    ...
    let create_conversation = app
        ...
        .oneshot(
            Request::builder()
                ...
                .uri("/im/v3/api/chat/conversations")
                .with_dual_token_tenant("t_demo")
                .with_dual_token_user("u_ext_owner")
                .with_dual_token_actor_kind("user")
                .with_dual_token_device("d_ext_owner")
                .with_dual_token_session("s_ext_owner")
                .header("content-type", "application/json")
                .body(Body::from(
                    r#"{
    ...
    let create_group = app
        ...
        .oneshot(
            Request::builder()
                ...
                .uri("/im/v3/api/chat/conversations")
                .with_dual_token_tenant("t_demo")
                .with_dual_token_user("u_group_owner")
                .with_dual_token_actor_kind("user")
                .with_dual_token_device("d_group_owner")
                .with_dual_token_session("s_group_owner")
                .header("content-type", "application/json")
                .body(Body::from(
                    r#"{
    ...
    let create_agent_dialog = app
        ...
        .oneshot(
            Request::builder()
                ...
                .with_dual_token_tenant("t_demo")
                .with_dual_token_user("u_dialog_owner")
                .with_dual_token_actor_kind("user")
                .with_dual_token_device("d_dialog_owner")
                .with_dual_token_session("s_dialog_owner")
                .header("content-type", "application/json")
                .body(Body::from(
                    r#"{
    ...
    let create_system_channel = app
        ...
        .oneshot(
            Request::builder()
                ...
                .with_dual_token_tenant("t_demo")
                .with_dual_token_user("svc_system")
                .with_dual_token_actor_kind("system")
    ...
    let create_agent_handoff = app
        ...
        .oneshot(
            Request::builder()
                ...
                .with_dual_token_tenant("t_demo")
                .with_dual_token_user("ag_handoff_source")
                .with_dual_token_actor_kind("agent")
                .with_dual_token_device("d_handoff_source")
                .with_dual_token_session("s_handoff_source")
                .header("content-type", "application/json")
                .body(Body::from(
                    r#"{
    ...
    let create_group = app
        .oneshot(
            Request::builder()
                ...
                .uri("/im/v3/api/chat/conversations")
                .with_dual_token_tenant("t_demo")
                .with_dual_token_user("u_disabled_creator")
                .with_dual_token_actor_kind("user")
                .with_dual_token_device("d_disabled_creator")
                .with_dual_token_session("s_disabled_creator")
                .header("content-type", "application/json")
                .body(Body::from(
                    r#"{
    ...
    let create_agent_dialog = app
        .oneshot(
            Request::builder()
                ...
                .uri("/im/v3/api/chat/conversations/agent_dialogs")
                .with_dual_token_tenant("t_demo")
                .with_dual_token_user("u_disabled_dialog_owner")
                .with_dual_token_actor_kind("user")
                .with_dual_token_device("d_disabled_dialog_owner")
                .with_dual_token_session("s_disabled_dialog_owner")
                .header("content-type", "application/json")
                .body(Body::from(
                    r#"{
    ...
    let create_group = app
        ...
        .oneshot(
            Request::builder()
                ...
                .uri("/im/v3/api/chat/conversations")
                .with_dual_token_tenant("t_demo")
                .with_dual_token_user("u_group_owner_external")
                .with_dual_token_actor_kind("user")
                .with_dual_token_device("d_group_owner_external")
                .with_dual_token_session("s_group_owner_external")
                .header("content-type", "application/json")
                .body(Body::from(
                    r#"{
    ...
    let create_system_channel = app
        ...
        .oneshot(
            Request::builder()
                ...
                .uri("/im/v3/api/chat/conversations/system_channels")
                .with_dual_token_tenant("t_demo")
                .with_dual_token_user("svc_system_external")
                .with_dual_token_actor_kind("system")
                .with_dual_token_device("d_system_external")
                .with_dual_token_session("s_system_external")
                .header("content-type", "application/json")
                .body(Body::from(
                    r#"{
    ...
    let create_agent_handoff = app
        ...
        .oneshot(
            Request::builder()
                ...
                .uri("/im/v3/api/chat/conversations/agent_handoffs")
                .with_dual_token_tenant("t_demo")
                .with_dual_token_user("ag_handoff_source_external")
                .with_dual_token_actor_kind("agent")
                .with_dual_token_device("d_handoff_source_external")
                .with_dual_token_session("s_handoff_source_external")
                .header("content-type", "application/json")
                .body(Body::from(
                    r#"{
    ...
    let create_conversation = app
        ...
        .oneshot(
            Request::builder()
                ...
                .uri("/im/v3/api/chat/conversations")
                .with_dual_token_tenant("t_demo")
                .with_dual_token_user("u_editor_local")
                .with_dual_token_actor_kind("user")
                .with_dual_token_device("d_editor_local")
                .with_dual_token_session("s_editor_local")
                .header("content-type", "application/json")
                .body(Body::from(
                    r#"{
    ...
    let create_conversation = app
        ...
        .oneshot(
            Request::builder()
                ...
                .uri("/im/v3/api/chat/conversations")
                .with_dual_token_tenant("t_demo")
                .with_dual_token_user("u_editor_external")
                .with_dual_token_actor_kind("user")
                .with_dual_token_device("d_editor_external")
                .with_dual_token_session("s_editor_external")
                .header("content-type", "application/json")
                .body(Body::from(
                    r#"{
