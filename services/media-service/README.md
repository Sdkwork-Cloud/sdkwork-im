...
This README is the SDKWork module entrypoint for `media-service`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
...
- `cargo test --manifest-path apps/sdkwork-im/services/media-service/Cargo.toml`
