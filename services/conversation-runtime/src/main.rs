...
const ALLOW_ALL_PRINCIPALS_ENV: &str = "CRAW_CHAT_ALLOW_ALL_PRINCIPALS";
const BIND_ADDR_ENV: &str = "CRAW_CHAT_CONVERSATION_RUNTIME_BIND_ADDR";
        ...
        .filter(|value| !value.is_empty())
    {
        ...
        None => {
            ...
            if allow_all {
                ...
                conversation_runtime::build_public_app_with_allow_all_principals()
            } else {
                return Err(format!(
