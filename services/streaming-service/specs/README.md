# Streaming Service Component Specs

This directory is the local standards index for `streaming-service`.
...
| Type | `rust-crate` |
| Root | `craw-chat/services/streaming-service` |
...
- `cargo test --manifest-path apps/craw-chat/services/streaming-service/Cargo.toml`
