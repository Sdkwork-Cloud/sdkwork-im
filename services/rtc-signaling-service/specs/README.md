# Rtc Signaling Service Component Specs

This directory is the local standards index for `rtc-signaling-service`.
...
| Field | Value |
| --- | --- |
| Name | `rtc-signaling-service` |
| Type | `rust-crate` |
| Root | `craw-chat/services/rtc-signaling-service` |
...
- `cargo test --manifest-path apps/craw-chat/services/rtc-signaling-service/Cargo.toml`
