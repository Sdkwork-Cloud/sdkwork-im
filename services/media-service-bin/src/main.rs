...
const BIND_ADDR_ENV: &str = "SDKWORK_IM_MEDIA_SERVICE_BIND_ADDR";
const DEFAULT_BIND_ADDR: &str = "127.0.0.1:18086";

#[tokio::main]
async fn main() -> ExitCode {
    sdkwork_im_service_readiness::ensure_im_service_process_identity("media-service");
...
async fn run() -> Result<(), String> {
    ...
    axum::serve(listener, sdkwork_router_im_media_app_api::build_public_app())
