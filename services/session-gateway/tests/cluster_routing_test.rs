...
fn test_cluster_bridge_routes_client_route_event_to_owner_node_runtime() {
    ...
    cluster
        .bind_client_route_for_principal_kind(            "t_demo",            "default",            "u_demo",
            "user",
            "d_pad",
            "node_b",
            None,
    ...
    let owner_window = expect_ok(
        runtime_b.list_events_for_principal_kind("t_demo", "default", "u_demo", "user", "d_pad", 0, 10),
    );
    assert_eq!(owner_window.items.len(), 1);
    assert_eq!(owner_window.items[0].event_type, "message.posted");

    let origin_window = expect_ok(
        runtime_a.list_events_for_principal_kind("t_demo", "default", "u_demo", "user", "d_pad", 0, 10),
    );
...
fn test_cluster_bridge_rejects_new_route_binds_when_node_is_draining() {
    ...
    let error = cluster
        .bind_client_route_for_principal_kind(
            "t_demo", "default", "u_demo", "user", "d_new", "node_a", None, "http",
        )
    ...
    let preserved = cluster
        .resolve_client_route_for_principal_kind("t_demo", "default", "u_demo", "user", "d_existing")
...
fn test_cluster_bridge_release_route_reconciles_draining_node_to_drained() {
    ...
    let released = cluster
        .release_client_route_for_principal_kind("t_demo", "default", "u_demo", "user", "d_existing", "node_a")
...
fn test_cluster_bridge_migrates_route_and_realtime_state_to_target_node() {
    ...
    let migrated_route = cluster
        .resolve_client_route_for_principal_kind("t_demo", "default", "u_demo", "user", "d_pad")
    ...
    let target_checkpoint = expect_ok(
        runtime_b.window_checkpoint_for_principal_kind("t_demo", "default", "u_demo", "user", "d_pad"),
    );
...
fn test_cluster_bridge_isolates_same_actor_id_across_principal_kinds_for_routes_and_publish() {
    ...
    let agent_route = cluster
        .resolve_client_route_for_principal_kind("t_demo", "default", "u_demo", "agent", "d_pad")
    ...
    let agent_window = expect_ok(
        runtime_b.list_events_for_principal_kind("t_demo", "default", "u_demo", "agent", "d_pad", 0, 10),
    );
...
fn test_cluster_disconnect_fence_isolated_by_principal_kind() {
    ...
    cluster
        .ensure_client_route_resume_not_required_for_principal_kind(
            "t_demo", "default", "u_demo", "agent", "d_pad",
        )
...
fn test_cluster_bridge_rebind_latest_owner_transfers_realtime_state() {
    ...
    let ack =
        expect_ok(runtime_a.ack_events_for_principal_kind("t_demo", "default", "u_demo", "user", "d_pad", 1));
...
fn test_cluster_bridge_rejects_route_bind_for_unknown_node() {
    ...
    let route =
        cluster.resolve_client_route_for_principal_kind("t_demo", "default", "u_demo", "user", "d_missing");
    assert!(
        route.is_none(),
...
fn test_cluster_route_bound_at_advances_between_distinct_bind_and_migration_operations() {
    ...
    let second_route = cluster
        .bind_client_route_for_principal_kind(
            "t_demo", "default", "u_demo", "user", "d_two", "node_a", None, "http",
        )
    ...
    let migrated_route = cluster
        .resolve_client_route_for_principal_kind("t_demo", "default", "u_demo", "user", "d_one")
...
fn test_cluster_bridge_public_route_models_use_runtime_route_owner_types() {
    ...
    let migrated: RouteBinding = cluster
        .resolve_client_route_for_principal_kind("t_demo", "default", "u_demo", "user", "d_runtime_owner")
