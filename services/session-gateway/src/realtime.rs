...
mod tests {
    ...
    fn test_collect_matched_delivery_targets_filters_to_registered_matching_devices() {
        ...
        subscriptions.insert(
            client_route_scope_key("t_demo", "default", "u_demo", "user", "d_match"),
        ...
        subscriptions.insert(
            client_route_scope_key("t_demo", "default", "u_demo", "user", "d_other_scope"),
            RealtimeClientRouteSubscriptions::from_items(vec![subscription(
                "conversation",
                "c_other",
                vec!["message.posted"],
        ...
        subscriptions.insert(
            client_route_scope_key("t_demo", "default", "u_demo", "user", "d_other_event"),
            RealtimeClientRouteSubscriptions::from_items(vec![subscription(
                "conversation",
                "c_demo",
                vec!["message.read"],
        ...
        let subscription_scope_index = subscription_scope_index_from_subscriptions(&[
            (
                "d_match",
                subscriptions
                    .get(client_route_scope_key("t_demo", "default", "u_demo", "user", "d_match").as_str())
    ...
    fn test_collect_matched_delivery_targets_accepts_wildcard_event_subscriptions() {
        let mut subscriptions = HashMap::new();
        subscriptions.insert(
            client_route_scope_key("t_demo", "default", "u_demo", "user", "d_wildcard"),
            RealtimeClientRouteSubscriptions::from_items(vec![subscription(
                "conversation",
                "c_demo",
                vec![],
        ...
        let subscription_scope_index = subscription_scope_index_from_subscriptions(&[(
            "d_wildcard",
            subscriptions
                .get(client_route_scope_key("t_demo", "default", "u_demo", "user", "d_wildcard").as_str())
    ...
    fn test_persist_checkpoint_normalizes_transient_inconsistent_sequence_state() {
        ...
        let scope_key = client_route_scope_key("t_demo", "default", "u_demo", "user", "d_pad");
        ...
        runtime
            .persist_checkpoint_for_principal_kind("t_demo", "default", "u_demo", "user", "d_pad")
    ...
    fn test_ensure_client_route_state_recovers_from_poisoned_sequence_store_lock() {
        ...
        runtime
            .ensure_client_route_state_for_principal_kind("t_demo", "default", "u_demo", "user", "d_poison")
            .expect("poisoned lock should be recovered");
        let checkpoint = runtime
            .window_checkpoint_for_principal_kind("t_demo", "default", "u_demo", "user", "d_poison")
    ...
    fn test_list_events_filters_hidden_conversation_scopes_and_advances_cursor() {
        ...
        let window = runtime
            .list_events_for_principal_kind("t_demo", "default", "u_demo", "user", "d_pad", 0, 10)
