...
//!
//! The current offline workspace does not include a PostgreSQL driver crate, so
//! these constants freeze the executable SQL shape against the checked-in
//! migration schema. A future adapter should bind parameters exactly as each
