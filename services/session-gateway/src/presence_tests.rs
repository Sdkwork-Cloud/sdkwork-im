...
fn test_presence_state_store_load_recovers_from_poisoned_lock() {
    ...
    let restored = store
        .load_state("t_demo", "default", "user", "u_demo", "d_poison")
...
fn test_presence_state_store_isolates_organizations_for_same_principal_and_device() {
    ...
    let listed_a = store
        .list_states_for_principal("t_demo", "org_a", "user", "u_demo")
    ...
    let listed_b = store
        .list_states_for_principal("t_demo", "org_b", "user", "u_demo")
    ...
    assert!(
        store
            .load_state("t_demo", "org_a", "user", "u_demo", "d_phone")
