...
fn test_route_rebind_recovers_from_poisoned_runtime_registry_lock() {
    ...
    let result = panic::catch_unwind(AssertUnwindSafe(|| {
        cluster.bind_client_route_for_principal_kind(            "t_demo",            "default",            "u_demo",
            "user",
            "d_pad",
            "node_b",
            Some("s_new"),
...
fn test_route_session_fence_requires_session_id_once_route_is_bound_to_session() {
    ...
    let error = cluster
        .ensure_route_session_current_for_principal_kind("t_demo", "default", "u_demo", "user", "d_pad", None)
...
fn test_disconnect_fence_store_failures_surface_as_controlled_cluster_errors() {
    ...
    let clear_error = cluster
        .clear_client_route_disconnect_fence_for_principal_kind("t_demo", "default", "u_demo", "user", "d_pad")
