...
pub const SHARED_CHANNEL_SYNC_RUNTIME_PROFILE_ENV: &str = "SDKWORK_IM_RUNTIME_PROFILE";
pub const SHARED_CHANNEL_SYNC_TARGET_BASE_URL_ENV: &str =
    "SDKWORK_IM_SHARED_CHANNEL_SYNC_TARGET_BASE_URL";
...
const FRIEND_REQUEST_CURSOR_HS256_SECRET_ENV: &str = "SDKWORK_IM_FRIEND_REQUEST_CURSOR_HS256_SECRET";
...
fn control_plane_openapi_spec() -> OpenApiServiceSpec<'static> {
    OpenApiServiceSpec {
        title: "Control Plane API",
        version: env!("CARGO_PKG_VERSION"),
        description: "Detailed OpenAPI contract for the Sdkwork IM control-plane runtime, including protocol governance, provider policy, social control workflows, and node lifecycle operations.",
