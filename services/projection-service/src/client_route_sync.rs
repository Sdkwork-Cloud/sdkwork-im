...
pub(crate) fn register_client_route_default_user(
    ...
    register_client_route_for_principal_kind(service, tenant_id, principal_id, "user", device_id)
}
...
fn register_client_route_with_principal_kind(
    ...
    let scope = client_route_principal_scope_key(tenant_id, principal_id, principal_kind);
...
pub(crate) fn client_route_sync_feed_window_for_principal_kind(
    ...
    let scope = client_route_feed_scope_key(tenant_id, principal_id, principal_kind, device_id);
...
impl TimelineProjectionService {
    pub fn register_client_route(
        ...
        register_client_route_default_user(self, tenant_id, principal_id, device_id)
    }
    ...
    pub fn registered_client_routes(
        ...
        self::registered_client_routes_for_principal_kind(self, tenant_id, principal_id, "user")
    }
...
fn resolved_client_route_scope_principal_kind(
    ...
    if scope_contains_client_route(
        ...
        &client_route_principal_scope_key(tenant_id, principal_id, principal_kind),
        device_id,
    ) {
