...
mod tests {
    ...
    fn test_persist_conversation_snapshot_batches_projection_store_flushes() {
        ...
        projection.register_client_route("t_demo", "default", "u_member", "d_phone");
        projection
            ...
            timeline_store
                .load_timeline(
                    ...
                    client_route_sync_snapshot_scope(&client_route_feed_scope_key(
                        "t_demo", "default", "user", "u_member", "d_phone"
                    ))
                    .as_str(),
                )
    ...
    fn test_restore_conversation_snapshot_recovers_from_poisoned_summary_store_lock() {
        ...
        let snapshot_scope = conversation_snapshot_scope("t_demo", "default", "c_demo");
