# Projection Service Component Specs

This directory is the local standards index for `projection-service`.
...
| Type | `rust-crate` |
| Root | `craw-chat/services/projection-service` |
...
- `cargo test --manifest-path apps/craw-chat/services/projection-service/Cargo.toml`
