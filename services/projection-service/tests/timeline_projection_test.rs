...
fn test_message_posted_event_projects_into_timeline_view() {
    ...
    assert_eq!(
        service.timeline("t_demo", "default", "c_demo"),
...
fn test_timeline_window_returns_cursor_metadata_and_rejects_oversized_limit() {
    ...
    let first = service.timeline_window("t_demo", "default", "c_page", Some(0), 2);
    assert_eq!(
        first
            .items
            .iter()
    ...
    let second = service.timeline_window("t_demo", "default", "c_page", Some(2), 2);
    assert_eq!(
        second
            .items
            .iter()
...
fn test_timeline_projection_stores_entries_in_message_sequence_order() {
    ...
    assert_eq!(
        service
            .timeline("t_demo", "default", "c_ordered")
            .iter()
            .map(|entry| entry.message_seq)
            .collect::<Vec<_>>(),
        vec![1, 2],
...
fn test_message_posted_event_projects_into_conversation_summary_view() {
    ...
    let summary = service
        .conversation_summary("t_demo", "default", "c_summary")
...
fn test_read_cursor_event_projects_into_cursor_view_with_unread_count() {
    ...
    let cursor = service
        .read_cursor_for_principal_kind("t_demo", "default", "c_cursor", "u_demo", "user")
...
fn test_member_role_changed_event_updates_member_snapshot() {
    ...
    let member = service
        .member_snapshot_for_principal_kind("t_demo", "default", "c_role_projection", "u_member", "user")
...
fn test_inbox_unread_count_excludes_messages_sent_by_current_principal() {
    ...
    let owner_cursor = service
        .read_cursor_for_principal_kind("t_demo", "default", "c_received_unread_projection", "u_owner", "user")
...
fn test_client_route_sync_feed_projects_registered_client_routes_for_message_and_read_cursor_events()
 {
    ...
    service
        .apply(&member_joined)
        .expect("member projection should succeed");
    service.register_client_route("t_demo", "default", "u_demo", "d_phone");
    service.register_client_route("t_demo", "default", "u_demo", "d_pad");
    service
        .apply(&message_posted)
        .expect("message projection should succeed");
    service
...
fn test_rtc_signal_message_client_route_sync_feed_preserves_message_payload_for_state_backfill() {
    ...
    service
        .apply(&member_joined)
        .expect("member projection should succeed");
    service.register_client_route("t_demo", "default", "u_alice", "d_pad");
    service
...
fn test_read_cursor_client_route_sync_fanout_uses_cursor_principal_kind() {
    ...
    service.register_client_route_for_principal_kind("t_demo", "default", "bot", "agent", "d_agent");
    service.register_client_route_for_principal_kind("t_demo", "default", "bot", "system", "d_system");
...
fn test_client_route_sync_feed_window_is_bounded_and_reports_trimmed_boundary() {
    ...
    service
        .apply(&member_joined)
        .expect("member projection should succeed");
    service.register_client_route_for_principal_kind("t_demo", "default", "u_owner", "user", "d_owner");
    service.register_client_route_for_principal_kind("t_demo", "default", "u_owner", "user", "d_pad");
...
fn test_member_governance_events_project_typed_sync_feed_deltas() {
    ...
    service.register_client_route("t_demo", "default", "u_owner", "d_owner");
    service.register_client_route("t_demo", "default", "u_other", "d_other");
    service.register_client_route("t_demo", "default", "u_leave", "d_leave");
...
fn test_registered_client_routes_and_latest_sync_seq_are_queryable() {
    ...
    let devices = service.registered_client_routes("t_demo", "default", "u_demo");
    assert_eq!(devices.len(), 2);
    assert!(devices.iter().any(|item| item.device_id == "d_phone"));
    assert!(devices.iter().any(|item| item.device_id == "d_pad"));

    assert_eq!(
        service.latest_client_route_sync_seq("t_demo", "default", "u_demo", "d_phone"),
        1
    );
    assert_eq!(
        service.latest_client_route_sync_seq("t_demo", "default", "u_demo", "d_pad"),
        1
    );
    assert_eq!(
        service.latest_client_route_sync_seq("t_demo", "default", "u_demo", "d_missing"),
        0
    );
}
...
fn test_friendship_events_project_to_contact_client_route_sync_feeds_for_both_users() {
    ...
    service.register_client_route("t_demo", "default", "u_alice", "d_alice");
    service.register_client_route("t_demo", "default", "u_bob", "d_bob");
...
fn test_realtime_fanout_targets_for_recipients_return_registered_principal_device_pairs() {
    ...
    service.register_client_route("t_demo", "default", "u_b", "d_phone");
    service.register_client_route("t_demo", "default", "u_a", "d_watch");
    service.register_client_route("t_demo", "default", "u_a", "d_pad");
...
fn test_client_route_sync_fanout_targets_for_conversation_include_active_members_and_fallback_devices()
 {
    ...
    service.register_client_route("t_demo", "default", "u_owner", "d_phone");
    service.register_client_route("t_demo", "default", "u_owner", "d_pad");
    service.register_client_route("t_demo", "default", "u_member", "d_watch");
    service.register_client_route("t_demo", "default", "u_removed", "d_removed");
...
fn test_timeline_window_filters_expired_retention_entries() {
    ...
    .with_payload(
        ...
        r#"{
            ...
            "messageId":"m_expired",
            "messageSeq":1,
            "sender":{"id":"u_owner","kind":"user","memberId":"cm_retention_filter","metadata":{}},
            "messageType":"standard",
            "deliveryMode":"discrete",
    ...
    let window = service.timeline_window("t_demo", "default", "c_retention_filter", None, 10);
...
fn test_legal_hold_policy_clears_timeline_retention_until() {
    ...
    .with_payload(
        ...
        r#"{
            ...
            "messageId":"m_hold",
            "messageSeq":1,
            "sender":{"id":"u_owner","kind":"user","memberId":"cm_legal_hold","metadata":{}},
            "messageType":"standard",
            "deliveryMode":"discrete",
    ...
    let window = service.timeline_window("t_demo", "default", "c_legal_hold", None, 10);
    assert_eq!(window.items.len(), 1);
...
fn test_typed_realtime_recipients_exclude_non_member_devices_sharing_same_actor_id() {
    ...
    service.register_client_route_for_principal_kind("t_demo", "default", "u_owner", "user", "d_owner");
    service.register_client_route_for_principal_kind("t_demo", "default", "u_dual", "user", "d_dual_user");
    service.register_client_route_for_principal_kind("t_demo", "default", "u_dual", "agent", "d_dual_agent");
...
fn test_client_route_sync_state_isolated_for_same_actor_and_device_across_principal_kinds() {
    ...
    service.register_client_route_for_principal_kind("t_demo", "default", "u_owner", "user", "d_owner");
    service.register_client_route_for_principal_kind("t_demo", "default", "u_dual", "user", "d_shared");
    service.register_client_route_for_principal_kind("t_demo", "default", "u_dual", "agent", "d_shared");
...
fn test_default_client_route_registration_does_not_leak_across_principal_kinds() {
    ...
    let default_client_route = service.register_client_route("t_demo", "default", "u_dual", "d_legacy");
    assert_eq!(default_client_route.principal_kind, "user");

    let user_client_routes =
        service.registered_client_routes_for_principal_kind("t_demo", "default", "u_dual", "user");
    assert_eq!(user_client_routes.len(), 1);
    assert_eq!(user_client_routes[0].device_id, "d_legacy");
    assert_eq!(user_client_routes[0].principal_kind, "user");

    let agent_client_routes =
        service.registered_client_routes_for_principal_kind("t_demo", "default", "u_dual", "agent");
    assert!(
...
fn test_default_client_route_queries_default_to_user_principal_kind() {
    ...
    service.register_client_route_for_principal_kind("t_demo", "default", "u_dual", "user", "d_user");
    service.register_client_route_for_principal_kind("t_demo", "default", "u_dual", "agent", "d_agent");

    let default_client_routes = service.registered_client_routes("t_demo", "default", "u_dual");
...
fn test_registered_client_route_timestamps_advance_between_distinct_registrations() {
    ...
    let first = service.register_client_route("t_demo", "default", "u_demo", "d_phone");
    sleep(Duration::from_millis(20));
    let second = service.register_client_route("t_demo", "default", "u_demo", "d_pad");
...
fn test_reaction_and_pin_events_project_into_interaction_summary_views() {
    ...
    let summary = service
        .message_interaction_summary("t_demo", "default", "c_interaction", "msg_c_interaction_1")
    ...
    assert!(
        service
            .pinned_messages("t_demo", "default", "c_interaction")
            .is_empty(),
...
fn test_message_interaction_reactions_are_isolated_by_actor_kind() {
    ...
    let summary = service
        .message_interaction_summary("t_demo", "default", "c_interaction_typed_actor",
...
fn test_agent_handoff_lifecycle_projects_into_summary_and_inbox_views() {
    ...
    let initial_summary = service
        .conversation_summary("t_demo", "default", "c_handoff_projection")
...
fn test_agent_handoff_status_change_projects_client_route_sync_entries_for_active_members() {
    ...
    service
        .apply(&target_member_joined)
        .expect("target member projection should succeed");
    service.register_client_route("t_demo", "default", "u_member", "d_pad");
    service.register_client_route_for_principal_kind("t_demo", "default", "ag_source", "agent", "d_agent");
    service
        .apply(&handoff_accepted)
        .expect("handoff accepted projection should succeed");
