...
This README is the SDKWork module entrypoint for `sdkwork-im-gateway`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
...
- `cargo test -p sdkwork-im-gateway`
