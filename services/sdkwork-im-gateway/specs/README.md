...
This directory is the local standards index for `sdkwork-im-gateway`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-im-gateway` |
| Type | `rust-crate` |
| Root | `sdkwork-im/services/sdkwork-im-gateway` |
...
- `cargo test --manifest-path apps/sdkwork-im/services/sdkwork-im-gateway/Cargo.toml`
