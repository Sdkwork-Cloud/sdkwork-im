...
const replacements = [
  ...
  ['powershell -NoProfile -ExecutionPolicy Bypass -File bin/deploy-local.ps1 -ProfileName self-hosted.split-services.development -SmokeBaseUrl http://127.0.0.1:18079', 'pnpm im:dev'],
  ['powershell -NoProfile -ExecutionPolicy Bypass -File bin/status-local.ps1 -ProfileName self-hosted.split-services.development', 'pnpm server:dev (topology v2)'],
  ['bin/deploy-local.ps1', 'pnpm im:dev'],
  ['bin/deploy-local.cmd', 'pnpm im:dev'],
  ['bin/deploy-local.sh', 'pnpm im:dev'],
  ['bin/start-local.ps1', 'pnpm server:dev'],
  ['bin/start-local.sh', 'pnpm server:dev'],
