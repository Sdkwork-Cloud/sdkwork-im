...
import {
  ...
  type KnowledgeDoc,
} from '../../apps/sdkwork-im-pc/packages/sdkwork-im-pc-knowledge/src/services/KnowledgeService';
...
async function main(): Promise<void> {
  const knowledgeServiceSource = read(
    'apps/sdkwork-im-pc/packages/sdkwork-im-pc-knowledge/src/services/KnowledgeService.ts',
  );
  ...
  console.log('sdkwork-im-pc knowledge service real logic contract passed');
}
