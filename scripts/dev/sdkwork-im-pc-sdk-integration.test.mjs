...
const drivePackageJson = readJson('apps/sdkwork-im-pc/packages/sdkwork-im-pc-drive/package.json');
assert.ok(
...
assert.ok(
  drivePackageJson.dependencies['@sdkwork/im-pc-core'],
  'Drive package must declare the PC core SDK wrapper dependency',
);

const driveServiceSource = read('apps/sdkwork-im-pc/packages/sdkwork-im-pc-drive/src/services/DriveService.ts');
const driveViewSource = read('apps/sdkwork-im-pc/packages/sdkwork-im-pc-drive/src/index.tsx');
const driveDetailPanelSource = read(
  'apps/sdkwork-im-pc/packages/sdkwork-im-pc-drive/src/components/DriveDetailPanel.tsx',
);
...
const knowledgeAiServiceSource = read('apps/sdkwork-im-pc/packages/sdkwork-im-pc-knowledge/src/services/KnowledgeAiService.ts');
const knowledgeServiceSource = read('apps/sdkwork-im-pc/packages/sdkwork-im-pc-knowledge/src/services/KnowledgeService.ts');
const knowledgeCreateKbModalSource = read('apps/sdkwork-im-pc/packages/sdkwork-im-pc-knowledge/src/components/CreateKBModal.tsx');
const knowledgeDocEditorSource = read('apps/sdkwork-im-pc/packages/sdkwork-im-pc-knowledge/src/components/DocEditor.tsx');
const knowledgeIndexSource = read('apps/sdkwork-im-pc/packages/sdkwork-im-pc-knowledge/src/index.tsx');
assert.match(
