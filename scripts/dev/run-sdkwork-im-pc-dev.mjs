...
const SDKWORK_API_GATEWAY_AUTOSTART_ENV_KEYS = [
  'SDKWORK_IM_FOUNDATION_API_GATEWAY_AUTOSTART',
...
const TARGETS = Object.freeze({
  ...
  desktop: {
    ...
    pnpmArgs: ['--dir', 'apps/sdkwork-im-pc/packages/sdkwork-im-pc-desktop', 'desktop:dev:local'],
  },
});
...
export function createSdkworkChatPcDevPlan({
  ...
  const unifiedServerEnv = {
    ...
    SDKWORK_IM_FOUNDATION_API_GATEWAY_BASE_URL: foundationApiGatewayBaseUrl,
    SDKWORK_IM_WEB_GATEWAY_RUNTIME_MODE: 'split',
