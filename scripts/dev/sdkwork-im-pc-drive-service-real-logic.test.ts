...
import {
  createDriveService,
  type DriveFileItem,
} from '../../apps/sdkwork-im-pc/packages/sdkwork-im-pc-drive/src/services/DriveService';
...
async function main(): Promise<void> {
  const serviceSource = read('apps/sdkwork-im-pc/packages/sdkwork-im-pc-drive/src/services/DriveService.ts');
  const viewSource = read('apps/sdkwork-im-pc/packages/sdkwork-im-pc-drive/src/index.tsx');
  ...
  console.log('sdkwork-im-pc drive service real logic contract passed');
}
