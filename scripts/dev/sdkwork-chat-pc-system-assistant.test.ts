...
import type { Chat } from '../../apps/sdkwork-chat-pc/packages/sdkwork-clawchat-pc-types/src/chat';
import {
  createSdkworkSystemAssistantService,
  SYSTEM_ASSISTANT_AGENT,
} from '../../apps/sdkwork-chat-pc/packages/sdkwork-clawchat-pc-chat/src/services/SystemAssistantService';
...
async function main(): Promise<void> {
  ...
  console.log('sdkwork-chat-pc system assistant contract passed');
}
