...
for (const required of [
  ...
  'SDKWORK_IM_SERVER_WEBSOCKET_BASE_URL=wss://realtime.example.com/sdkwork/chat',
  'SDKWORK_IM_SERVER_INSTANCE=default',
  'SDKWORK_IM_SERVER_CONFIG_DIR=/etc/sdkwork/chat',
  'SDKWORK_IM_SERVER_DATA_DIR=/var/lib/sdkwork/chat',
  'SDKWORK_IM_SERVER_LOG_DIR=/var/log/sdkwork/chat',
  'SDKWORK_IM_SERVER_RUN_DIR=/run/sdkwork/chat',
  'SDKWORK_IM_SERVER_BASE_URL=https://chat.example.com/sdkwork/chat',
  'SDKWORK_IM_SERVER_API_BASE_URL=https://chat.example.com/sdkwork/chat',
  'SDKWORK_IM_SERVER_WEBSOCKET_BASE_URL=wss://realtime.example.com/sdkwork/chat',
  'SDKWORK_IM_PC_API_UPSTREAM=https://chat.example.com/sdkwork/chat',
