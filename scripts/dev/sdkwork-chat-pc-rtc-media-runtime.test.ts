...
} from '../../apps/sdkwork-chat-pc/packages/sdkwork-clawchat-pc-chat/src/services/RtcMediaService';
import { createSdkworkRtcMediaService } from '../../apps/sdkwork-chat-pc/packages/sdkwork-clawchat-pc-chat/src/services/RtcMediaService';
...
async function main(): Promise<void> {
  ...
  assert.deepEqual(localVideoCalls, [
    {
      method: 'setLocalVideoPlayer',
      playerId: 'sdkwork-chat-pc-local-video-preview',
  ...
  console.log('sdkwork-chat-pc RTC media runtime contract passed');
}
