...
const prefixRegistry = {
  ...
  prefixes: [{ prefix: 'im_', owner: 'im-platform', domain: 'im' }],
};
...
process.stdout.write(`materialized ${tableNames.length} tables into IM database contract\n`);
