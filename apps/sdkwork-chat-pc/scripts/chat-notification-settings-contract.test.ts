...
import type * as SettingsServiceModule from '../packages/sdkwork-clawchat-pc-chat/src/services/SettingsService.ts';
...
console.log('sdkwork chat pc notification settings contract passed.');
