...
import type * as KnowledgeServiceModule from '../packages/sdkwork-clawchat-pc-knowledge/src/services/KnowledgeService.ts';
...
async function loadKnowledgeServiceModule(): Promise<KnowledgeServiceExports> {
  const moduleUrl = pathToFileURL(
    './packages/sdkwork-clawchat-pc-knowledge/src/services/KnowledgeService.ts',
  ).href;
...
console.log('sdkwork chat pc knowledge service document count contract passed.');
