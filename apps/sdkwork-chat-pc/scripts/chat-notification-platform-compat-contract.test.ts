...
const desktopManifestSource = readFileSync(
  './packages/sdkwork-clawchat-pc-desktop/src-tauri/Cargo.toml',
  'utf8',
);
assert.match(
...
const desktopLibSource = readFileSync(
  './packages/sdkwork-clawchat-pc-desktop/src-tauri/src/lib.rs',
  'utf8',
);
assert.match(
  desktopLibSource,
...
const desktopNotificationSource = readFileSync(
  './packages/sdkwork-clawchat-pc-desktop/src-tauri/src/notification.rs',
  'utf8',
);
assert.match(
...
const desktopCapabilitySource = readFileSync(
  './packages/sdkwork-clawchat-pc-desktop/src-tauri/capabilities/default.json',
  'utf8',
);
assert.doesNotMatch(
...
console.log('sdkwork chat pc notification platform compatibility contract passed.');
