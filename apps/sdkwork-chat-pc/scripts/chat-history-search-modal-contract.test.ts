...
import type { Message } from '../packages/sdkwork-clawchat-pc-types/src/message';
...
const searchModel = await import('../packages/sdkwork-clawchat-pc-chat/src/services/ChatHistorySearchModel') as typeof import('../packages/sdkwork-clawchat-pc-chat/src/services/ChatHistorySearchModel');
const displayModel = await import('../packages/sdkwork-clawchat-pc-chat/src/services/ChatHistoryMessageDisplayModel') as typeof import('../packages/sdkwork-clawchat-pc-chat/src/services/ChatHistoryMessageDisplayModel');
...
console.log('sdkwork chat history search modal contract passed.');
