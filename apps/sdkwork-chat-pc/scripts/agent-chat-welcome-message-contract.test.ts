...
const chatTypeSource = parseSource('./packages/sdkwork-clawchat-pc-types/src/chat.ts');
assert.ok(
...
const chatServiceText = readFileSync(
  './packages/sdkwork-clawchat-pc-chat/src/services/ChatService.ts',
  'utf8',
);
...
const chatWindowText = readFileSync(
  './packages/sdkwork-clawchat-pc-chat/src/components/ChatWindow.tsx',
  'utf8',
);
assert.ok(
...
console.log('sdkwork chat pc agent chat welcome message contract passed.');
