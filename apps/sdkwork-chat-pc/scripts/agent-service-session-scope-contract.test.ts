...
const SESSION_STORAGE_KEY = 'sdkwork-chat-pc:session:v1';
...
function installSession(): void {
  ...
  localStorage.setItem(
    ...
    JSON.stringify({
      ...
      context: {
        appId: 'craw-chat-sdkwork-chat-pc',
        authLevel: 'password',
...
console.log('sdkwork chat pc agent service session-derived scope contract passed.');
