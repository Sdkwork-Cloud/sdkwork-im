...
const notificationCenterSource = readFileSync(
  './packages/sdkwork-clawchat-pc-chat/src/components/NotificationCenter.tsx',
  'utf8',
);
...
console.log('sdkwork chat pc notification ui wiring contract passed.');
