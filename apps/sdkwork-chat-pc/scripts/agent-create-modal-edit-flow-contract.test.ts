...
const modalSourceText = readFileSync(
  './packages/sdkwork-clawchat-pc-chat/src/components/CreateAgentModal.tsx',
  'utf8',
);
...
const defaultsSourceText = readFileSync(
  './packages/sdkwork-clawchat-pc-chat/src/components/AgentDefaults.ts',
  'utf8',
);
...
console.log('sdkwork chat pc create agent modal edit flow contract passed.');
