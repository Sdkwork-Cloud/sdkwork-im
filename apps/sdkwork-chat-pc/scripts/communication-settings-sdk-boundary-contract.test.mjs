...
const groupServiceSource = read(
  'apps/sdkwork-chat-pc/packages/sdkwork-clawchat-console-communications/src/services/GroupService.ts',
);
const consoleAnnouncementServiceSource = read(
  'apps/sdkwork-chat-pc/packages/sdkwork-clawchat-console-communications/src/services/AnnouncementService.ts',
);
const adminAnnouncementServiceSource = read(
  'apps/sdkwork-chat-pc/packages/sdkwork-clawchat-admin-operations/src/services/AdminAnnouncementService.ts',
);
const adminSettingsServiceSource = read(
  'apps/sdkwork-chat-pc/packages/sdkwork-clawchat-admin-operations/src/services/AdminSettingsService.ts',
);
const sysSettingsServiceSource = read(
  'apps/sdkwork-chat-pc/packages/sdkwork-clawchat-console-settings/src/services/SysSettingsService.ts',
);
...
console.log('sdkwork chat pc communication and settings SDK boundary contract passed.');
