# @sdkwork/clawchat-pc-commons

Domain: communication
Capability: clawchat-pc-commons
Package type: node-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/clawchat-pc-commons`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
