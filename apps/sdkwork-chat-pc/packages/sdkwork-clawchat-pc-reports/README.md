# @sdkwork/clawchat-pc-reports

Domain: communication
Capability: clawchat-pc-reports
Package type: node-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/clawchat-pc-reports`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
