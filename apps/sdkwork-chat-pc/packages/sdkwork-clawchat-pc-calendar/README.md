# @sdkwork/clawchat-pc-calendar

Domain: communication
Capability: clawchat-pc-calendar
Package type: node-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/clawchat-pc-calendar`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
