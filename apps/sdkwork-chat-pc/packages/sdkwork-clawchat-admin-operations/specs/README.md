...
This directory is the local SDKWork component contract for `@sdkwork/clawchat-admin-operations`.

- Component root: `craw-chat/apps/sdkwork-chat-pc/packages/sdkwork-clawchat-admin-operations`
