# @sdkwork/clawchat-admin-operations

Domain: communication
Capability: clawchat-admin-operations
Package type: node-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/clawchat-admin-operations`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
