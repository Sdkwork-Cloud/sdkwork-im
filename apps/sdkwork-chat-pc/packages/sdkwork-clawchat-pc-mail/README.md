# @sdkwork/clawchat-pc-mail

Domain: communication
Capability: clawchat-pc-mail
Package type: node-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/clawchat-pc-mail`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
