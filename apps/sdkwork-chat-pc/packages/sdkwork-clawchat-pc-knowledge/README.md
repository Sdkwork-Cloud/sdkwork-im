# @sdkwork/clawchat-pc-knowledge

Domain: communication
Capability: clawchat-pc-knowledge
Package type: node-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/clawchat-pc-knowledge`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
