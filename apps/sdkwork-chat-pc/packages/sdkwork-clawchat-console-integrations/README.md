# @sdkwork/clawchat-console-integrations

Domain: communication
Capability: clawchat-console-integrations
Package type: node-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/clawchat-console-integrations`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
