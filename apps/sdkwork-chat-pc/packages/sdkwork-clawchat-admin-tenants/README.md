# @sdkwork/clawchat-admin-tenants

Domain: iam
Capability: clawchat-admin-tenants
Package type: node-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/clawchat-admin-tenants`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
