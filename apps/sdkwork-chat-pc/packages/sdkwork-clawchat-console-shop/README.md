# @sdkwork/clawchat-console-shop

Domain: communication
Capability: clawchat-console-shop
Package type: node-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/clawchat-console-shop`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
