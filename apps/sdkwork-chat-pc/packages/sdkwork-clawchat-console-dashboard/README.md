# @sdkwork/clawchat-console-dashboard

Domain: communication
Capability: clawchat-console-dashboard
Package type: node-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/clawchat-console-dashboard`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
