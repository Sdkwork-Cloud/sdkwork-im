# @sdkwork/clawchat-pc-voice

Domain: communication
Capability: clawchat-pc-voice
Package type: react-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/clawchat-pc-voice`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
