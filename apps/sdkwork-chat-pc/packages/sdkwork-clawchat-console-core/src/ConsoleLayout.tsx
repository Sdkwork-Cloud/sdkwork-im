import { ConsoleDashboard } from '@sdkwork/clawchat-console-dashboard';
...
import { ConsoleRoles } from '@sdkwork/clawchat-console-roles';
import { TenantUsers } from '@sdkwork/clawchat-console-users';
import { ConsoleGroups, ConsoleMessages, ConsoleAnnouncements } from '@sdkwork/clawchat-console-communications';
import { ConsoleIntegrations } from '@sdkwork/clawchat-console-integrations';
import { ConsoleSecurity, ConsoleAnalytics } from '@sdkwork/clawchat-console-security';
import { ConsoleSettings } from '@sdkwork/clawchat-console-settings';
import { ConsoleStores } from '@sdkwork/clawchat-console-shop';
import { ConsoleProducts } from '@sdkwork/clawchat-console-product';
    ...
    <div className="flex h-screen w-full bg-console-bg-root text-console-text-main font-sans">
      ...
      <div className="w-[260px] bg-console-bg-sidebar border-r border-console-border flex flex-col shadow-sm z-10">
        <div className="h-[64px] flex items-center px-6 border-b border-console-border">
          ...
          <div>
            <div className="font-bold text-[15px] text-console-text-main leading-tight">ClawChat Console</div>
