# @sdkwork/clawchat-console-roles

Domain: iam
Capability: clawchat-console-roles
Package type: node-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/clawchat-console-roles`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
