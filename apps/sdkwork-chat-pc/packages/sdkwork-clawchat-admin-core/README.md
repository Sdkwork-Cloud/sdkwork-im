# @sdkwork/clawchat-admin-core

Domain: communication
Capability: clawchat-admin-core
Package type: node-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/clawchat-admin-core`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
