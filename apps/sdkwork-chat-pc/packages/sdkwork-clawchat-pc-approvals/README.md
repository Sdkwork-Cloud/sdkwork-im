# @sdkwork/clawchat-pc-approvals

Domain: communication
Capability: clawchat-pc-approvals
Package type: node-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/clawchat-pc-approvals`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
