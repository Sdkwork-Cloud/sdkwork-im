# @sdkwork/clawchat-console-communications

Domain: communication
Capability: clawchat-console-communications
Package type: node-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/clawchat-console-communications`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
