...
export const SignaturePadMobileQR: React.FC<SignaturePadMobileQRProps> = ({ signatureUrl }) => {
  ...
  return (
    <div className="flex flex-col items-center bg-[#181818] border border-white/10 rounded-2xl p-6 w-72 shrink-0 shadow-lg">
        ...
        <button onClick={() => void copySignatureLink()} className="w-full flex items-center justify-center gap-2 text-sm text-indigo-400 bg-indigo-500/10 hover:bg-indigo-500/20 py-2 rounded-lg transition-colors border border-indigo-500/20">
