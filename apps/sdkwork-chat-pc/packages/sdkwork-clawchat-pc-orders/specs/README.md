...
This directory is the local SDKWork component contract for `@sdkwork/clawchat-pc-orders`.

- Component root: `craw-chat/apps/sdkwork-chat-pc/packages/sdkwork-clawchat-pc-orders`
