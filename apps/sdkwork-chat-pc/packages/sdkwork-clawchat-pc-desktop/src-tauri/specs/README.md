...
This directory is the local SDKWork component contract for `sdkwork-chat-pc`.

- Component root: `craw-chat/apps/sdkwork-chat-pc/packages/sdkwork-clawchat-pc-desktop/src-tauri`
