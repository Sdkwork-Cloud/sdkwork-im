# @sdkwork/clawchat-pc-voice-gen

Domain: communication
Capability: clawchat-pc-voice-gen
Package type: node-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/clawchat-pc-voice-gen`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
