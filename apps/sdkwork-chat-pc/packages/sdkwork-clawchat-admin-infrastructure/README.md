# @sdkwork/clawchat-admin-infrastructure

Domain: communication
Capability: clawchat-admin-infrastructure
Package type: node-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/clawchat-admin-infrastructure`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
