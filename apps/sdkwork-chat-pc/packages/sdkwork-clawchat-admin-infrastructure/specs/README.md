...
This directory is the local SDKWork component contract for `@sdkwork/clawchat-admin-infrastructure`.

- Component root: `craw-chat/apps/sdkwork-chat-pc/packages/sdkwork-clawchat-admin-infrastructure`
