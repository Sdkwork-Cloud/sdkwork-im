  ...
  return (
    ...
    >
      ...
      <div className="flex-1 relative flex flex-col items-center justify-center bg-black/95 group overflow-hidden">
        ...
        <div className="absolute top-0 left-0 right-0 p-6 flex justify-between items-start z-30">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3 bg-black/40 backdrop-blur-md rounded-full p-1 pr-4 border border-white/10 cursor-pointer hover:bg-black/60 transition-colors">
              <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-indigo-500 to-purple-500 overflow-hidden">
                <img src={`https://ui-avatars.com/api/?name=${course.instructor}&background=random`} alt="Avatar" className="w-full h-full object-cover" />
              </div>
              <div className="pr-2">
                ...
                <p className="text-[11px] text-gray-300 font-medium">14.5w 粉丝</p>
              </div>
              <button 
        ...
        <div className="absolute top-24 right-6 w-40 aspect-[3/4] bg-gray-900 rounded-xl overflow-hidden border border-white/20 shadow-2xl group/pip cursor-move pointer-events-auto z-40">
            <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&q=80&w=400" className="w-full h-full object-cover" alt="Teacher" />
        ...
        <div className="absolute bottom-32 left-6 flex flex-col gap-2 pointer-events-none z-30">
          <motion.div 
            ...
            className="bg-gradient-to-r from-pink-500/80 to-transparent backdrop-blur-md rounded-l-full rounded-r-xl p-1 pr-6 flex items-center gap-2 border-l-2 border-pink-300 shadow-xl"
          >
            ...
            <div>
              <div className="text-[12px] text-pink-100 font-bold leading-none mb-1">Alex_Dev 赠送</div>
              <div className="text-[14px] text-white font-bold leading-none drop-shadow-md">🚀 穿云箭 x1</div>
            </div>
          </motion.div>
        </div>
            ...
            {messages.map((msg) => (
              ...
              >
                <div className="w-7 h-7 rounded-full bg-white/10 shrink-0 mt-0.5 overflow-hidden">
                   <img src={`https://ui-avatars.com/api/?name=${msg.user}&background=random&size=32`} alt="avatar" />
                </div>
                <div className={`p-2.5 rounded-2xl rounded-tl-sm text-[13px] leading-relaxed block overflow-hidden ${msg.user === '我' ? 'bg-indigo-500 text-white' : 'bg-white/5 text-gray-200'}`}>
                  {msg.user !== '我' && (
