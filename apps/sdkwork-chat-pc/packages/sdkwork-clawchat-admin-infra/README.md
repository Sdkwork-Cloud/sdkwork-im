# @sdkwork/clawchat-admin-infra

Domain: communication
Capability: clawchat-admin-infra
Package type: node-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/clawchat-admin-infra`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
