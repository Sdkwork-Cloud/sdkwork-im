...
export const ShopHome = ({
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-r from-pink-600/90 to-purple-800/80 z-10 mix-blend-multiply transition-opacity duration-500 group-hover:opacity-70" />
        <img
