  ...
  return (
    <div className="w-full lg:w-[380px] shrink-0">
      <div className="bg-[#2b2b2d] rounded-3xl border border-white/5 p-8 sticky top-6 shadow-xl shadow-black/20">
        ...
        <button
          className="w-full py-4 bg-gradient-to-r from-pink-600 to-pink-500 hover:from-pink-500 hover:to-pink-400 text-white rounded-2xl font-bold text-lg transition-all shadow-[0_8px_16px_rgba(236,72,153,0.2)] hover:shadow-[0_8px_20px_rgba(236,72,153,0.3)] flex items-center justify-center gap-2 active:scale-[0.98] mt-4"
