# @sdkwork/clawchat-pc-shop

Domain: communication
Capability: clawchat-pc-shop
Package type: node-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/clawchat-pc-shop`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
