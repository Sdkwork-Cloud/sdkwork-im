# @sdkwork/clawchat-pc-music-gen

Domain: communication
Capability: clawchat-pc-music-gen
Package type: node-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/clawchat-pc-music-gen`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
