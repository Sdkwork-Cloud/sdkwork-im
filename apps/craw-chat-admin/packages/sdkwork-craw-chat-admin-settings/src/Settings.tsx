          ...
          <div className="space-y-3">
            ...
            <div className="space-y-1">
              ...
              <div className="text-sm text-[var(--sdk-color-text-secondary)]">
                {t('Search shortcuts, browse the Operations directory, and switch settings without leaving the shared shell for Workspace Ops, Conversation Governance, System, moderation, realtime, transcript, and incident operations.')}
              </div>
            </div>
          </div>
        }
