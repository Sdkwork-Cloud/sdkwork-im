...
import { useAdminAppStore, useAdminI18n } from 'sdkwork-control-plane-core';
...
export function WorkspaceSettings() {
  ...
  return (
    <div className="space-y-8">
      <InlineAlert
        description={t(
          'Every shell preference persists so the control-plane workspace reopens with the same layout, transcript density, and operator posture.',
        )}
        showIcon
