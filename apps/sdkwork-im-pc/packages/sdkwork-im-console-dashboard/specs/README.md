...
This directory is the local SDKWork component contract for `@sdkwork/im-console-dashboard`.

- Component root: `sdkwork-im/apps/sdkwork-im-pc/packages/sdkwork-im-console-dashboard`
