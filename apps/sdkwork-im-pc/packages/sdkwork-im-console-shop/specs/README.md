...
This directory is the local SDKWork component contract for `@sdkwork/im-console-shop`.

- Component root: `sdkwork-im/apps/sdkwork-im-pc/packages/sdkwork-im-console-shop`
