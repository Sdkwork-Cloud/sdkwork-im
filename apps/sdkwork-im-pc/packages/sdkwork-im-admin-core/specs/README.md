...
This directory is the local SDKWork component contract for `@sdkwork/im-admin-core`.

- Component root: `sdkwork-im/apps/sdkwork-im-pc/packages/sdkwork-im-admin-core`
