        ...
        <div className="bg-admin-bg-panel border border-admin-border rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="p-6 space-y-8">
            ...
            <div className="pt-6 border-t border-admin-border flex justify-end">
              <button className="bg-indigo-600 hover:bg-indigo-500 text-white px-6 py-2.5 rounded-lg text-sm font-medium flex items-center gap-2 shadow-[0_0_15px_rgba(79,70,229,0.3)] transition-colors">
                <Save size={16} />
                Save Configurations
              </button>
            </div>
