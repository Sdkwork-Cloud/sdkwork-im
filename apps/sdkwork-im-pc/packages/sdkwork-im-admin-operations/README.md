# @sdkwork/im-admin-operations

Domain: communication
Capability: im-admin-operations
Package type: node-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/im-admin-operations`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
