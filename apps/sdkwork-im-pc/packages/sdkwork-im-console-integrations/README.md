# @sdkwork/im-console-integrations

Domain: communication
Capability: im-console-integrations
Package type: node-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/im-console-integrations`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
