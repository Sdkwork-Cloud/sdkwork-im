...
This directory is the local SDKWork component contract for `@sdkwork/im-admin-tenants`.

- Component root: `sdkwork-im/apps/sdkwork-im-pc/packages/sdkwork-im-admin-tenants`
