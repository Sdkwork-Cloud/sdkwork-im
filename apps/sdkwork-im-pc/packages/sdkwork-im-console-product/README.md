# @sdkwork/im-console-product

Domain: communication
Capability: im-console-product
Package type: node-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/im-console-product`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
