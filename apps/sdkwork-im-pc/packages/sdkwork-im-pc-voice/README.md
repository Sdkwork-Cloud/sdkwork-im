...
Capability: im-pc-voice
Package type: react-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/im-pc-voice`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
