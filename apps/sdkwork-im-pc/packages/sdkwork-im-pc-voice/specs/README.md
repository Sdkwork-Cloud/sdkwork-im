...
This directory is the local SDKWork component contract for `@sdkwork/im-pc-voice`.

- Component root: `sdkwork-im/apps/sdkwork-im-pc/packages/sdkwork-im-pc-voice`
