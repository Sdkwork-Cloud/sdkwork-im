...
This directory is the local SDKWork component contract for `@sdkwork/im-admin-infrastructure`.

- Component root: `sdkwork-im/apps/sdkwork-im-pc/packages/sdkwork-im-admin-infrastructure`
