# @sdkwork/im-pc-voice-gen

Domain: communication
Capability: im-pc-voice-gen
Package type: node-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/im-pc-voice-gen`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
