...
import { type ResolvedImWebSocketAuthOptions } from './websocket-auth.js';
...
interface ImInternalResolvedSdkClientOptions {
    ...
    authToken?: string;
    webSocketAuth: ResolvedImWebSocketAuthOptions;
...
export declare class ImSdkContext {
    ...
    readonly webSocketAuth: ImInternalSdkContextOptions['webSocketAuth'];
    private authToken?;
    constructor(transportClient: ImTransportClientLike, transport?: ImInternalTransportConfig, webSocketFactory?: ImInternalSdkContextOptions['webSocketFactory'], webSocketAuth?: ImInternalSdkContextOptions['webSocketAuth'], initialAuthToken?: string);
