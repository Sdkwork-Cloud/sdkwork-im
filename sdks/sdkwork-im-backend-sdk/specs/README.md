...
| Authority OpenAPI | `openapi/craw-chat-backend-api.openapi.yaml` |
| Derived OpenAPI | `openapi/craw-chat-backend-api.sdkgen.yaml` |
...
- `sdkwork-appbase-backend-sdk`: role `appbase-backend-management-capability`, `dependencyMode: consumer-sdk`, `generatedTransportImportPolicy: forbidden`
