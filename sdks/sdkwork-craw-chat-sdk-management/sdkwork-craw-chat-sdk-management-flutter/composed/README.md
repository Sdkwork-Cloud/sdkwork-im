# craw_chat_sdk_management

Composed Flutter SDK for Craw Chat operator-console management backend.

This package sits above the generated `craw_chat_management_backend_sdk` package and provides:

- the consumer-facing `CrawChatManagementClient`
- business-oriented domain fields
- flattened client creation arguments for straightforward onboarding

The generated `craw_chat_management_backend_sdk` package remains generator-owned under
...
The preferred consumer entrypoint is `CrawChatManagementClient.create(...)`.
