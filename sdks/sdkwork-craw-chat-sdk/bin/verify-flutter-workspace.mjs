...
runWorkspaceCommand({
  prefix,
  command: 'node',
  args: [path.join(scriptDir, 'verify-auth-surface-alignment.mjs'), '--language', 'flutter'],
  cwd: workspaceRoot,
...
runWorkspaceCommand({
  prefix,
  command: 'node',
  args: [path.join(scriptDir, 'verify-flutter-composed-parity.mjs')],
  cwd: workspaceRoot,
...
runWorkspaceCommand({
  prefix,
  command: 'node',
  args: [path.join(scriptDir, 'verify-flutter-media-upload-surface.mjs')],
  cwd: workspaceRoot,
  step: 'flutter:media-upload-surface',
});
runWorkspaceCommand({
  prefix,
  command: 'node',
