...
export interface CrawChatBackendClientLike {
    ...
    portal: {
        getHome(): Promise<CrawChatAppSnapshot>;
        getAuth(): Promise<CrawChatAppSnapshot>;
        getWorkspace(): Promise<CrawChatWorkspace>;
        getDashboard(): Promise<CrawChatAppSnapshot>;
        getConversations(): Promise<CrawChatAppSnapshot>;
        getRealtime(): Promise<CrawChatAppSnapshot>;
        getMedia(): Promise<CrawChatAppSnapshot>;
        getAutomation(): Promise<CrawChatAppSnapshot>;
        getGovernance(): Promise<CrawChatAppSnapshot>;
    };
    session: {
...
//# sourceMappingURL=backend-client-like.d.ts.map