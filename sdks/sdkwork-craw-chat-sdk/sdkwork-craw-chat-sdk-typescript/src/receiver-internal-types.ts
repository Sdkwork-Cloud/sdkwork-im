...
export interface CrawChatInternalReceiverMessageEvent
  extends CrawChatInternalReceiverEventBase<'message'> {
  messageId?: string;
  conversationId?: string;
  message: CrawChatDecodedMessage;
}

export interface CrawChatInternalReceiverDataEvent
  extends CrawChatInternalReceiverEventBase<'data'> {
  data: CrawChatDecodedDataPayload;
}

export interface CrawChatInternalReceiverRtcSignalEvent
  extends CrawChatInternalReceiverEventBase<'rtc_signal'> {
  signal: CrawChatDecodedRtcSignal;
}

export interface CrawChatInternalReceiverUnknownEvent
  extends CrawChatInternalReceiverEventBase<'unknown'> {}

export type CrawChatInternalReceiverEvent =
