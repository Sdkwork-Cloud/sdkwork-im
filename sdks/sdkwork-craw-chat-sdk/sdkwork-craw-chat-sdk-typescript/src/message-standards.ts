...
) as Record<string, CrawChatStructuredMessageKind>;

export function resolveStructuredMessageSchema(
  kind: CrawChatStructuredMessageKind,
): string {
...
export function resolveStructuredMessageKind(
  schemaRef?: string,
): CrawChatStructuredMessageKind | 'custom' | undefined {
  if (!schemaRef) {
    return undefined;
  }
