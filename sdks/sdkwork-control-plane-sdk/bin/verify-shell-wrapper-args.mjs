...
appendShellWrapperForwardingFailures({
  source: readWorkspaceSource({
    workspaceRoot,
    relativePath: 'sdkwork-control-plane-sdk-typescript/bin/sdk-verify.sh',
  }),
  failures,
...
appendShellWrapperForwardingFailures({
  source: readWorkspaceSource({
    workspaceRoot,
    relativePath: 'sdkwork-control-plane-sdk-flutter/bin/sdk-verify.sh',
  }),
  failures,
...
appendShellWrapperForwardingFailures({
  source: readWorkspaceSource({
    workspaceRoot,
    relativePath: 'sdkwork-control-plane-sdk-typescript/bin/sdk-gen.sh',
  }),
  failures,
...
appendShellWrapperForwardingFailures({
  source: readWorkspaceSource({
    workspaceRoot,
    relativePath: 'sdkwork-control-plane-sdk-flutter/bin/sdk-gen.sh',
  }),
  failures,
...
appendShellWrapperForwardingFailures({
  source: readWorkspaceSource({
    workspaceRoot,
    relativePath: 'sdkwork-control-plane-sdk-typescript/bin/sdk-assemble.sh',
  }),
  failures,
...
appendShellWrapperForwardingFailures({
  source: readWorkspaceSource({
    workspaceRoot,
    relativePath: 'sdkwork-control-plane-sdk-flutter/bin/sdk-assemble.sh',
  }),
  failures,
