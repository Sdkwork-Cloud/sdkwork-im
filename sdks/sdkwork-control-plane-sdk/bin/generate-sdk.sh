...
AUTHORITY_SPEC="${WORKSPACE_DIR}/openapi/control-plane.openapi.yaml"
DERIVED_SPEC="${WORKSPACE_DIR}/openapi/control-plane.sdkgen.yaml"
...
while [[ $# -gt 0 ]]; do
  case "$1" in
    --language)
      ...
      ;;
    *)
      echo "[sdkwork-control-plane-sdk] Unknown argument: $1" >&2
      exit 1
      ;;
  esac
done
