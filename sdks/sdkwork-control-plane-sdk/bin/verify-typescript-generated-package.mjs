...
if (packageJson.name !== '@sdkwork/control-plane-backend-sdk') {
  failTypescriptPackageVerification({
    prefix,
    message: 'TypeScript generated package name must stay on @sdkwork/control-plane-backend-sdk.',
  });
}
...
console.log('[sdkwork-control-plane-sdk] TypeScript generated package verification passed.');
