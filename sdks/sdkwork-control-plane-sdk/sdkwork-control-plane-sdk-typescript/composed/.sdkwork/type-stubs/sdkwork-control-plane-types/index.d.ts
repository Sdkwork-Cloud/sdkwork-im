...
export type AdminRouteModuleId = 'sdkwork-control-plane-overview' | 'sdkwork-control-plane-tenants' | 'sdkwork-control-plane-users' | 'sdkwork-control-plane-conversations' | 'sdkwork-control-plane-messages' | 'sdkwork-control-plane-groups' | 'sdkwork-control-plane-moderation' | 'sdkwork-control-plane-automation' | 'sdkwork-control-plane-announcements' | 'sdkwork-control-plane-realtime' | 'sdkwork-control-plane-system' | 'sdkwork-control-plane-storage' | 'sdkwork-control-plane-settings';
