...
import { ControlPlaneSdkClient } from '../dist/index.js';
...
async function testConstructedClientExposesSemanticModules() {
  ...
  const sdk = new ControlPlaneSdkClient({ backendClient });
...
async function testCreateAcceptsInjectedBackendClient() {
  ...
  const sdk = await ControlPlaneSdkClient.create({ backendClient });
