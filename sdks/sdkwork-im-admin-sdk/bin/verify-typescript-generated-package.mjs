...
runNpm(['run', 'build', '--silent'], {
  step: 'typescript-generated:npm-build',
  env: {
    ...process.env,
    NPM_CONFIG_CACHE: cacheDir,
  },
...
for (const [moduleName, moduleValue] of [
  ['esm:ImAdminBackendClient', esmModule.ImAdminBackendClient],
  ['esm:createImAdminBackendClient', esmModule.createImAdminBackendClient],
  ['esm:HttpClient', esmModule.HttpClient],
  ['esm:DefaultAuthTokenManager', esmModule.DefaultAuthTokenManager],
  ['cjs:ImAdminBackendClient', cjsModule.ImAdminBackendClient],
  ['cjs:createImAdminBackendClient', cjsModule.createImAdminBackendClient],
  ['cjs:HttpClient', cjsModule.HttpClient],
  ['cjs:DefaultAuthTokenManager', cjsModule.DefaultAuthTokenManager],
]) {
  if (moduleValue == null) {
...
console.log('[sdkwork-im-admin-sdk] TypeScript generated package verification passed.');
