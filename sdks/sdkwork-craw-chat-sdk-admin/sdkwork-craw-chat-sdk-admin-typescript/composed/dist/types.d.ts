import type { CrawChatAdminBackendConfig, FetchLike, Identifier, JsonObject, QueryParams } from './generated-backend-types.js';
export type { CrawChatAdminBackendConfig, FetchLike, Identifier, JsonObject, QueryParams, } from './generated-backend-types.js';
export interface CrawChatAdminBackendClientLike {
    meta: {
...
export interface CrawChatAdminSdkClientOptions {
    backendClient: CrawChatAdminBackendClientLike;
}
export interface CrawChatAdminSdkClientCreateOptions {
    backendClient?: CrawChatAdminBackendClientLike;
