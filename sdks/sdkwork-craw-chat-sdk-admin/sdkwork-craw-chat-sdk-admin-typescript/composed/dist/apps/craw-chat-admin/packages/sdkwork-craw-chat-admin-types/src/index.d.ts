export * from './storage';
export type AdminRouteKey = 'overview' | 'tenants' | 'users' | 'conversations' | 'messages' | 'groups' | 'moderation' | 'automation' | 'announcements' | 'realtime' | 'system' | 'storage' | 'settings';
export type ThemeMode = 'light' | 'dark' | 'system';
export type ThemeColor = 'tech-blue' | 'lobster' | 'green-tech' | 'zinc' | 'violet' | 'rose';
...
export type AdminRouteModuleId = 'sdkwork-craw-chat-admin-overview' | 'sdkwork-craw-chat-admin-tenants' | 'sdkwork-craw-chat-admin-users' | 'sdkwork-craw-chat-admin-conversations' | 'sdkwork-craw-chat-admin-messages' | 'sdkwork-craw-chat-admin-groups' | 'sdkwork-craw-chat-admin-moderation' | 'sdkwork-craw-chat-admin-automation' | 'sdkwork-craw-chat-admin-announcements' | 'sdkwork-craw-chat-admin-realtime' | 'sdkwork-craw-chat-admin-system' | 'sdkwork-craw-chat-admin-storage' | 'sdkwork-craw-chat-admin-settings';
...
export type ProviderIntegrationMode = 'standard_passthrough' | 'default_plugin' | 'custom_plugin';
