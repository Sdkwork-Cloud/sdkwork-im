...
function resolveFetchImplementation(config: CrawChatAdminBackendConfig): FetchLike {
  if (config.fetch) {
    return config.fetch;
  }
...
export class HttpClient {
  private readonly config: CrawChatAdminBackendConfig;
...
export function createHttpClient(config: CrawChatAdminBackendConfig): HttpClient {
