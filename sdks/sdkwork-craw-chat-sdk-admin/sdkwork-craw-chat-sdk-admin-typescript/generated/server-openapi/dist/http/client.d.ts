import type { CrawChatAdminBackendConfig, JsonObject, QueryParams } from '../types/common.js';
...
export declare function createHttpClient(config: CrawChatAdminBackendConfig): HttpClient;
export {};
