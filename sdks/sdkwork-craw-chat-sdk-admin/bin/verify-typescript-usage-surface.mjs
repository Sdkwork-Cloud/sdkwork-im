...
const expectations = [
  {
    ...
    pattern: /interface CrawChatAdminSdkClientCreateOptions[\s\S]*baseUrl\??:\s*string;/,
    source: typesSource,
  },
  {
    description: 'create options expose flat authToken',
    pattern: /interface CrawChatAdminSdkClientCreateOptions[\s\S]*authToken\??:\s*string;/,
    source: typesSource,
  },
  {
    description: 'create options expose flat headers',
    pattern: /interface CrawChatAdminSdkClientCreateOptions[\s\S]*headers\??:\s*Record<string,\s*string>;/,
    source: typesSource,
  },
  {
    description: 'create options expose flat timeout',
    pattern: /interface CrawChatAdminSdkClientCreateOptions[\s\S]*timeout\??:\s*number;/,
    source: typesSource,
  },
  {
    description: 'create options expose flat fetch',
    pattern: /interface CrawChatAdminSdkClientCreateOptions[\s\S]*fetch\??:\s*FetchLike;/,
    source: typesSource,
  },
  {
    description: 'create options do not expose backendConfig',
    pattern: /interface CrawChatAdminSdkClientCreateOptions[\s\S]*backendConfig\??:/,
    source: typesSource,
    negate: true,
  },
  {
...
finishFileExpectationVerification({
  ...
  successMessage: '[sdkwork-craw-chat-sdk-admin] TypeScript usage surface verification passed.',
});
