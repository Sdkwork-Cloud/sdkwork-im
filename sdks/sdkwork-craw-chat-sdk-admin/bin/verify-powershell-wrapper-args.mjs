...
appendLanguagePowerShellForwarderFailures({
  source: readWorkspacePowerShellWrapperSource({
    workspaceRoot,
    relativePath: 'sdkwork-craw-chat-sdk-admin-typescript/bin/sdk-gen.ps1',
  }),
  failures,
...
appendLanguagePowerShellForwarderFailures({
  source: readWorkspacePowerShellWrapperSource({
    workspaceRoot,
    relativePath: 'sdkwork-craw-chat-sdk-admin-flutter/bin/sdk-gen.ps1',
  }),
  failures,
...
appendLanguagePowerShellForwarderFailures({
  source: readWorkspacePowerShellWrapperSource({
    workspaceRoot,
    relativePath: 'sdkwork-craw-chat-sdk-admin-typescript/bin/sdk-verify.ps1',
  }),
  failures,
...
appendLanguagePowerShellForwarderFailures({
  source: readWorkspacePowerShellWrapperSource({
    workspaceRoot,
    relativePath: 'sdkwork-craw-chat-sdk-admin-flutter/bin/sdk-verify.ps1',
  }),
  failures,
...
appendLanguagePowerShellForwarderFailures({
  source: readWorkspacePowerShellWrapperSource({
    workspaceRoot,
    relativePath: 'sdkwork-craw-chat-sdk-admin-typescript/bin/sdk-assemble.ps1',
  }),
  failures,
...
appendLanguagePowerShellForwarderFailures({
  source: readWorkspacePowerShellWrapperSource({
    workspaceRoot,
    relativePath: 'sdkwork-craw-chat-sdk-admin-flutter/bin/sdk-assemble.ps1',
  }),
  failures,
