...
$AuthoritySpec = Join-Path $WorkspaceDir "openapi\admin-control-plane.openapi.yaml"
$DerivedSpec = Join-Path $WorkspaceDir "openapi\admin-control-plane.sdkgen.yaml"
