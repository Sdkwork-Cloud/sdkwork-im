...
const (
	RoomService_CreateRoom_FullMethodName   = "/sdkwork.communication.app.v3.RoomService/CreateRoom"
	RoomService_RetrieveRoom_FullMethodName = "/sdkwork.communication.app.v3.RoomService/RetrieveRoom"
	RoomService_EnterRoom_FullMethodName    = "/sdkwork.communication.app.v3.RoomService/EnterRoom"
	RoomService_LeaveRoom_FullMethodName    = "/sdkwork.communication.app.v3.RoomService/LeaveRoom"
)
...
func (c *roomServiceClient) RetrieveRoom(ctx context.Context, in *RetrieveRoomRequest, opts ...grpc.CallOption) (*RetrieveRoomResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RetrieveRoomResponse)
	err := c.cc.Invoke(ctx, RoomService_RetrieveRoom_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *roomServiceClient) EnterRoom(ctx context.Context, in *EnterRoomRequest, opts ...grpc.CallOption) (*EnterRoomResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EnterRoomResponse)
	err := c.cc.Invoke(ctx, RoomService_EnterRoom_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRoomServiceServer) RetrieveRoom(context.Context, *RetrieveRoomRequest) (*RetrieveRoomResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RetrieveRoom not implemented")
}
func (UnimplementedRoomServiceServer) EnterRoom(context.Context, *EnterRoomRequest) (*EnterRoomResponse, error) {
...
func _RoomService_RetrieveRoom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RoomService_RetrieveRoom_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _RoomService_EnterRoom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EnterRoomRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RoomServiceServer).EnterRoom(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RoomService_EnterRoom_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoomServiceServer).EnterRoom(ctx, req.(*EnterRoomRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RoomService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "sdkwork.communication.app.v3.RoomService",
	...
	Metadata: "sdkwork/communication/app/v3/room_service.proto",
}
