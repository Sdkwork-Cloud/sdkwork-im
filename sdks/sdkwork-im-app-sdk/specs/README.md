# SDKWork IM App API SDK Component Specs

This directory is the local standards index for `sdkwork-im-app-sdk`.
...
- `SdkworkImAppClient`
- `SdkworkAppClient` compatibility alias

## SDK Dependencies

The `sdkDependencies` contract is mandatory for this app SDK family:

- `sdkwork-iam-app-sdk`: role `appbase-identity-and-session-capability`, `dependencyMode: consumer-sdk`, `generatedTransportImportPolicy: forbidden`
