...
public class DeviceApi {
    ...
    /** Get the device twin */
    public DeviceTwinView devicesTwinRetrieve(String deviceId) throws Exception {
        Object raw = client.get(ApiPaths.appPath("/devices/" + serializePathParameter(deviceId, new PathParameterSpec("deviceId", "simple", false)) + "/twin"));
        return client.convertValue(raw, new TypeReference<DeviceTwinView>() {});
    }

    /** Update the desired state for a device twin */
    public DeviceTwinView devicesTwinDesiredUpdate(String deviceId, UpdateDeviceTwinDesiredRequest body) throws Exception {
        Object raw = client.post(ApiPaths.appPath("/devices/" + serializePathParameter(deviceId, new PathParameterSpec("deviceId", "simple", false)) + "/twin/desired"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<DeviceTwinView>() {});
    }

    /** Update the reported state for a device twin */
    public DeviceTwinView devicesTwinReportedUpdate(String deviceId, UpdateDeviceTwinReportedRequest body) throws Exception {
        Object raw = client.post(ApiPaths.appPath("/devices/" + serializePathParameter(deviceId, new PathParameterSpec("deviceId", "simple", false)) + "/twin/reported"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<DeviceTwinView>() {});
    }
