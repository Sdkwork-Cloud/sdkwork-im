...
public class NotificationApi {
    ...
    public NotificationListResponse notificationsList() throws Exception {
        Object raw = client.get(ApiPaths.appPath("/notifications"));
        return client.convertValue(raw, new TypeReference<NotificationListResponse>() {});
    }

    /** Request a notification task */
    public NotificationRequestResponse notificationsRequestsCreate(RequestNotification body) throws Exception {
        Object raw = client.post(ApiPaths.appPath("/notifications/requests"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<NotificationRequestResponse>() {});
    }

    /** Get a notification task */
    public NotificationTask notificationsRetrieve(String notificationId) throws Exception {
        Object raw = client.get(ApiPaths.appPath("/notifications/" + serializePathParameter(notificationId, new PathParameterSpec("notificationId", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<NotificationTask>() {});
    }
