...
export declare class DeviceTwinReportedApi {
    ...
    update(deviceId: string, body: UpdateDeviceTwinReportedRequest): Promise<DeviceTwinView>;
}
export declare class DeviceTwinDesiredApi {
    private client;
    constructor(client: HttpClient);
    /** Update the desired state for a device twin */
    update(deviceId: string, body: UpdateDeviceTwinDesiredRequest): Promise<DeviceTwinView>;
}
export declare class DeviceTwinApi {
    ...
    constructor(client: HttpClient);
    /** Get the device twin */
    retrieve(deviceId: string): Promise<DeviceTwinView>;
}
