...
public class DeviceApi {
    ...
    public DeviceSessionView sessionsResume(ResumeDeviceSessionRequest body) throws Exception {
        Object raw = client.post(ApiPaths.imPath("/device/sessions/resume"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<DeviceSessionView>() {});
    }

    /** Disconnect a device runtime session */
    public DeviceSessionDisconnectResponse sessionsDisconnect(RegisterDeviceRequest body) throws Exception {
        Object raw = client.post(ApiPaths.imPath("/device/sessions/disconnect"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<DeviceSessionDisconnectResponse>() {});
    }

    /** Register a device for sync feed delivery */
    public RegisteredDeviceView registrationsCreate(RegisterDeviceRequest body) throws Exception {
        Object raw = client.post(ApiPaths.imPath("/devices/register"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<RegisteredDeviceView>() {});
    }

    /** Retrieve bounded device sync feed entries */
    public DeviceSyncFeedResponse syncFeedRetrieve(String deviceId, Integer afterSeq, Integer limit) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.imPath("/devices/" + serializePathParameter(deviceId, new PathParameterSpec("deviceId", "simple", false)) + "/sync_feed"), query));
