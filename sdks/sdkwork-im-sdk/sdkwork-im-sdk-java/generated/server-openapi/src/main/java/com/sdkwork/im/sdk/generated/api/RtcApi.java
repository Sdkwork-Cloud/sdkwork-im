...
public class RtcApi {
    ...
    public RtcSession sessionsCreate(CreateRtcSessionRequest body) throws Exception {
        Object raw = client.post(ApiPaths.imPath("/rtc/sessions"), body, null, null, "application/json");
    ...
    public RtcSession sessionsRetrieve(String rtcSessionId) throws Exception {
        Object raw = client.get(ApiPaths.imPath("/rtc/sessions/" + serializePathParameter(rtcSessionId, new PathParameterSpec("rtcSessionId", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<RtcSession>() {});
    }
