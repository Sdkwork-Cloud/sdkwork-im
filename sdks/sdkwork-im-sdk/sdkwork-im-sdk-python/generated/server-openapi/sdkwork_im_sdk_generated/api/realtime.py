...
class RealtimeApi:
    """realtime realtime API client."""

    def __init__(self, client: HttpClient):
        self._client = client
        self.subscriptions = RealtimeSubscriptionsApi(client)
        self.events = RealtimeEventsApi(client)


class RealtimeSubscriptionsApi:
    """realtime realtime.subscriptions API client."""
...
class RealtimeEventsApi:
    """realtime realtime.events API client."""
