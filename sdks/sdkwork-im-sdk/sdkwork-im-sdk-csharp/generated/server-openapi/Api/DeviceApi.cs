...
namespace Sdkwork.Im.Sdk.Generated.Api
{
    public class DeviceApi
    {
        ...
        /// </summary>
        public async Task<Sdkwork.Im.Sdk.Generated.Models.DeviceSessionView?> SessionsResumeAsync(Sdkwork.Im.Sdk.Generated.Models.ResumeDeviceSessionRequest body)
        {
            return await _client.PostAsync<Sdkwork.Im.Sdk.Generated.Models.DeviceSessionView>(ApiPaths.ImPath("/device/sessions/resume"), body, null, null, "application/json");
        }

        /// <summary>
        /// Disconnect a device runtime session
        /// </summary>
        public async Task<Sdkwork.Im.Sdk.Generated.Models.DeviceSessionDisconnectResponse?> SessionsDisconnectAsync(Sdkwork.Im.Sdk.Generated.Models.RegisterDeviceRequest body)
        {
            return await _client.PostAsync<Sdkwork.Im.Sdk.Generated.Models.DeviceSessionDisconnectResponse>(ApiPaths.ImPath("/device/sessions/disconnect"), body, null, null, "application/json");
        }

        /// <summary>
        /// Register a device for sync feed delivery
        /// </summary>
        public async Task<Sdkwork.Im.Sdk.Generated.Models.RegisteredDeviceView?> RegistrationsCreateAsync(Sdkwork.Im.Sdk.Generated.Models.RegisterDeviceRequest body)
        {
            return await _client.PostAsync<Sdkwork.Im.Sdk.Generated.Models.RegisteredDeviceView>(ApiPaths.ImPath("/devices/register"), body, null, null, "application/json");
        }

        /// <summary>
        /// Retrieve bounded device sync feed entries
        /// </summary>
        public async Task<Sdkwork.Im.Sdk.Generated.Models.DeviceSyncFeedResponse?> SyncFeedRetrieveAsync(string deviceId, int? afterSeq = null, int? limit = null)
        {
            ...
            return await _client.GetAsync<Sdkwork.Im.Sdk.Generated.Models.DeviceSyncFeedResponse>(ApiPaths.AppendQueryString(ApiPaths.ImPath($"/devices/{SerializePathParameter(deviceId, new PathParameterSpec("deviceId", "simple", false))}/sync_feed"), queryString));
        }
