...
namespace Sdkwork.Im.Sdk.Generated.Api
{
    public class RtcApi
    {
        ...
        /// </summary>
        public async Task<Sdkwork.Im.Sdk.Generated.Models.RtcSession?> SessionsCreateAsync(Sdkwork.Im.Sdk.Generated.Models.CreateRtcSessionRequest body)
        {
            return await _client.PostAsync<Sdkwork.Im.Sdk.Generated.Models.RtcSession>(ApiPaths.ImPath("/rtc/sessions"), body, null, null, "application/json");
        }
        ...
        {
            return await _client.GetAsync<Sdkwork.Im.Sdk.Generated.Models.RtcSession>(ApiPaths.ImPath($"/rtc/sessions/{SerializePathParameter(rtcSessionId, new PathParameterSpec("rtcSessionId", "simple", false))}"));
        }
