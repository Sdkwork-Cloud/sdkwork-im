...
public class DeviceApi {
    ...
    public func sessionsResume(body: ResumeDeviceSessionRequest) async throws -> DeviceSessionView? {
        return try await client.post(ApiPaths.imPath("/device/sessions/resume"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: DeviceSessionView.self)
    }

    /// Disconnect a device runtime session
    public func sessionsDisconnect(body: RegisterDeviceRequest) async throws -> DeviceSessionDisconnectResponse? {
        return try await client.post(ApiPaths.imPath("/device/sessions/disconnect"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: DeviceSessionDisconnectResponse.self)
    }

    /// Register a device for sync feed delivery
    public func registrationsCreate(body: RegisterDeviceRequest) async throws -> RegisteredDeviceView? {
        return try await client.post(ApiPaths.imPath("/devices/register"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: RegisteredDeviceView.self)
    }

    /// Retrieve bounded device sync feed entries
    public func syncFeedRetrieve(deviceId: String, afterSeq: Int? = nil, limit: Int? = nil) async throws -> DeviceSyncFeedResponse? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.imPath("/devices/\(serializePathParameter(deviceId, PathParameterSpec(name: "deviceId", style: "simple", explode: false)))/sync_feed"), query), responseType: DeviceSyncFeedResponse.self)
    }
