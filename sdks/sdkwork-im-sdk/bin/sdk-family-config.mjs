...
export const sdkFamilyConfig = {
  ...
  generatedApiLabel: 'Craw Chat IM standardized development API',
  primaryClient: 'SdkworkImClient',
  apiPrefix: '/im/v3/api',
  schemaUrl: '/im/v3/openapi.json',
  authoritySpec: 'openapi/craw-chat-im.openapi.yaml',
  derivedSpec: 'openapi/craw-chat-im.sdkgen.yaml',
  flutterDerivedSpec: 'openapi/craw-chat-im.flutter.sdkgen.yaml',
  sdkDependencies: [],
  packages: {
