# Craw Chat Ccp Codec Json Component Specs

This directory is the local standards index for `craw-chat-ccp-codec-json`.
...
| Field | Value |
| --- | --- |
| Name | `craw-chat-ccp-codec-json` |
| Type | `rust-crate` |
| Root | `craw-chat/crates/craw-chat-ccp-codec-json` |
...
- `cargo test --manifest-path apps/craw-chat/crates/craw-chat-ccp-codec-json/Cargo.toml`
