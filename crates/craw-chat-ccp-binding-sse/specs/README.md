# Craw Chat Ccp Binding Sse Component Specs

This directory is the local standards index for `craw-chat-ccp-binding-sse`.
...
| Field | Value |
| --- | --- |
| Name | `craw-chat-ccp-binding-sse` |
| Type | `rust-crate` |
| Root | `craw-chat/crates/craw-chat-ccp-binding-sse` |
...
- `cargo test --manifest-path apps/craw-chat/crates/craw-chat-ccp-binding-sse/Cargo.toml`
