# Sdkwork IM Ccp Binding Sse Component Specs

This directory is the local standards index for `sdkwork-im-ccp-binding-sse`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-im-ccp-binding-sse` |
| Type | `rust-crate` |
| Root | `sdkwork-im/crates/sdkwork-im-ccp-binding-sse` |
