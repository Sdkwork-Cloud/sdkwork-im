...
pub fn im_discovery_config_from_env(
    ...
    let metadata = build_registration_metadata(RegistrationMetadataInput {
        ...
        deployment_profile: std::env::var("SDKWORK_IM_DEPLOYMENT_PROFILE").ok().as_deref(),
...
pub async fn register_im_discovery_instance(
    server_config: &ImRpcServerConfig,
) -> Result<Option<Arc<sdkwork_rpc_discovery::DiscoveryInstanceHandle>>, sdkwork_rpc_discovery::DiscoveryRegistrationError>
{
