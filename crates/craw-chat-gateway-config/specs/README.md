# Craw Chat Gateway Config Component Specs

This directory is the local standards index for `craw-chat-gateway-config`.
...
| Field | Value |
| --- | --- |
| Name | `craw-chat-gateway-config` |
| Type | `rust-crate` |
| Root | `craw-chat/crates/craw-chat-gateway-config` |
