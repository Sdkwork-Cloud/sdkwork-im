# Sdkwork IM API Registry Component Specs

This directory is the local standards index for `sdkwork-im-api-registry`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-im-api-registry` |
| Type | `rust-crate` |
| Root | `sdkwork-im/crates/sdkwork-im-api-registry` |
