# Craw Chat Contract Iot Component Specs

This directory is the local standards index for `craw-chat-contract-iot`.
...
| Field | Value |
| --- | --- |
| Name | `craw-chat-contract-iot` |
| Type | `rust-crate` |
| Root | `craw-chat/crates/craw-chat-contract-iot` |
