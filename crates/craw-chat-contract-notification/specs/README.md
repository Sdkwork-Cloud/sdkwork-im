# Craw Chat Contract Notification Component Specs

This directory is the local standards index for `craw-chat-contract-notification`.
...
| Field | Value |
| --- | --- |
| Name | `craw-chat-contract-notification` |
| Type | `rust-crate` |
| Root | `craw-chat/crates/craw-chat-contract-notification` |
...
- `cargo test --manifest-path apps/craw-chat/crates/craw-chat-contract-notification/Cargo.toml`
