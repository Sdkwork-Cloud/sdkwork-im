# Craw Chat Contract Message Component Specs

This directory is the local standards index for `craw-chat-contract-message`.
...
| Field | Value |
| --- | --- |
| Name | `craw-chat-contract-message` |
| Type | `rust-crate` |
| Root | `craw-chat/crates/craw-chat-contract-message` |
...
- `cargo test --manifest-path apps/craw-chat/crates/craw-chat-contract-message/Cargo.toml`
