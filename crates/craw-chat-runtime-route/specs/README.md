# Craw Chat Runtime Route Component Specs

This directory is the local standards index for `craw-chat-runtime-route`.
...
| Field | Value |
| --- | --- |
| Name | `craw-chat-runtime-route` |
| Type | `rust-crate` |
| Root | `craw-chat/crates/craw-chat-runtime-route` |
