# Sdkwork IM Contract Admin Component Specs

This directory is the local standards index for `sdkwork-im-contract-admin`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-im-contract-admin` |
| Type | `rust-crate` |
| Root | `sdkwork-im/crates/sdkwork-im-contract-admin` |
