# Sdkwork IM Ccp Registry Component Specs

This directory is the local standards index for `sdkwork-im-ccp-registry`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-im-ccp-registry` |
| Type | `rust-crate` |
| Root | `sdkwork-im/crates/sdkwork-im-ccp-registry` |
