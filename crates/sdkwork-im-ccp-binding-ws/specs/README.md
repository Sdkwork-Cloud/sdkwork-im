# Sdkwork IM Ccp Binding Ws Component Specs

This directory is the local standards index for `sdkwork-im-ccp-binding-ws`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-im-ccp-binding-ws` |
| Type | `rust-crate` |
| Root | `sdkwork-im/crates/sdkwork-im-ccp-binding-ws` |
