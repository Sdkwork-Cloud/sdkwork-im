# Craw Chat Ccp Binding Ws Component Specs

This directory is the local standards index for `craw-chat-ccp-binding-ws`.
...
| Field | Value |
| --- | --- |
| Name | `craw-chat-ccp-binding-ws` |
| Type | `rust-crate` |
| Root | `craw-chat/crates/craw-chat-ccp-binding-ws` |
...
- `cargo test --manifest-path apps/craw-chat/crates/craw-chat-ccp-binding-ws/Cargo.toml`
