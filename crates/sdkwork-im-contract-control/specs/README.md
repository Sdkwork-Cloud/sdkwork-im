# Sdkwork IM Contract Control Component Specs

This directory is the local standards index for `sdkwork-im-contract-control`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-im-contract-control` |
| Type | `rust-crate` |
| Root | `sdkwork-im/crates/sdkwork-im-contract-control` |
