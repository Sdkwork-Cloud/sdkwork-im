# Craw Chat Contract Agent Component Specs

This directory is the local standards index for `craw-chat-contract-agent`.
...
| Field | Value |
| --- | --- |
| Name | `craw-chat-contract-agent` |
| Type | `rust-crate` |
| Root | `craw-chat/crates/craw-chat-contract-agent` |
...
- `cargo test --manifest-path apps/craw-chat/crates/craw-chat-contract-agent/Cargo.toml`
