# sdkwork-router-im-social-backend-api

## Purpose

HTTP route crate for SDKWork IM `backend-api` surface at `/backend/v3/api/control/social`.
...
```bash
cargo check -p sdkwork-router-im-social-backend-api
