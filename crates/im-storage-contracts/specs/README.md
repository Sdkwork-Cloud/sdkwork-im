# Im Storage Contracts Component Specs

This directory is the local standards index for `im-storage-contracts`.
...
| Field | Value |
| --- | --- |
| Name | `im-storage-contracts` |
| Type | `rust-crate` |
| Root | `sdkwork-im/crates/im-storage-contracts` |
