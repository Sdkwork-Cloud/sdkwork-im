...
This README is the SDKWork module entrypoint for `im-storage-contracts`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
...
- `cargo test --manifest-path apps/sdkwork-im/crates/im-storage-contracts/Cargo.toml`
