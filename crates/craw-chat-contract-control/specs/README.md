# Craw Chat Contract Control Component Specs

This directory is the local standards index for `craw-chat-contract-control`.
...
| Field | Value |
| --- | --- |
| Name | `craw-chat-contract-control` |
| Type | `rust-crate` |
| Root | `craw-chat/crates/craw-chat-contract-control` |
...
- `cargo test --manifest-path apps/craw-chat/crates/craw-chat-contract-control/Cargo.toml`
