# Craw Chat Ccp Binding Mqtt Component Specs

This directory is the local standards index for `craw-chat-ccp-binding-mqtt`.
...
| Field | Value |
| --- | --- |
| Name | `craw-chat-ccp-binding-mqtt` |
| Type | `rust-crate` |
| Root | `craw-chat/crates/craw-chat-ccp-binding-mqtt` |
...
- `cargo test --manifest-path apps/craw-chat/crates/craw-chat-ccp-binding-mqtt/Cargo.toml`
