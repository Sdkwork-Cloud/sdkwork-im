...
This README is the SDKWork module entrypoint for `craw-chat-ccp-binding-mqtt`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
