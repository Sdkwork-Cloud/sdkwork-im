...
This README is the SDKWork module entrypoint for `im-platform-contracts`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
...
- `cargo test --manifest-path apps/sdkwork-im/crates/im-platform-contracts/Cargo.toml`
