# Im Platform Contracts Component Specs

This directory is the local standards index for `im-platform-contracts`.
...
| Field | Value |
| --- | --- |
| Name | `im-platform-contracts` |
| Type | `rust-crate` |
| Root | `sdkwork-im/crates/im-platform-contracts` |
