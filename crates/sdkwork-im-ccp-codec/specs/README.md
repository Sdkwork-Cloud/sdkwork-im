# Sdkwork IM Ccp Codec Component Specs

This directory is the local standards index for `sdkwork-im-ccp-codec`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-im-ccp-codec` |
| Type | `rust-crate` |
| Root | `sdkwork-im/crates/sdkwork-im-ccp-codec` |
