# Craw Chat Ccp Control Component Specs

This directory is the local standards index for `craw-chat-ccp-control`.
...
| Field | Value |
| --- | --- |
| Name | `craw-chat-ccp-control` |
| Type | `rust-crate` |
| Root | `craw-chat/crates/craw-chat-ccp-control` |
