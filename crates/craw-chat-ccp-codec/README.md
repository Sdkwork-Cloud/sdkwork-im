...
This README is the SDKWork module entrypoint for `craw-chat-ccp-codec`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
...
- `cargo test --manifest-path apps/craw-chat/crates/craw-chat-ccp-codec/Cargo.toml`
