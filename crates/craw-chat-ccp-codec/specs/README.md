# Craw Chat Ccp Codec Component Specs

This directory is the local standards index for `craw-chat-ccp-codec`.
...
| Field | Value |
| --- | --- |
| Name | `craw-chat-ccp-codec` |
| Type | `rust-crate` |
| Root | `craw-chat/crates/craw-chat-ccp-codec` |
