# Sdkwork IM Gateway Config Component Specs

This directory is the local standards index for `sdkwork-im-cloud-gateway-config`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-im-cloud-gateway-config` |
| Type | `rust-crate` |
| Root | `sdkwork-im/crates/sdkwork-im-cloud-gateway-config` |
...
- Split mode defaults Appbase, Drive, and Notary foundation upstreams to the shared
  `sdkwork-api-cloud-gateway` root. Direct dependency module URLs are explicit split-deployment
