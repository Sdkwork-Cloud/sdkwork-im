# Sdkwork IM Gateway Observability Component Specs

This directory is the local standards index for `sdkwork-im-cloud-gateway-observability`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-im-cloud-gateway-observability` |
| Type | `rust-crate` |
| Root | `sdkwork-im/crates/sdkwork-im-cloud-gateway-observability` |
