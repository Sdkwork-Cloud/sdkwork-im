# Sdkwork IM Ccp Codec Cbor Component Specs

This directory is the local standards index for `sdkwork-im-ccp-codec-cbor`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-im-ccp-codec-cbor` |
| Type | `rust-crate` |
| Root | `sdkwork-im/crates/sdkwork-im-ccp-codec-cbor` |
