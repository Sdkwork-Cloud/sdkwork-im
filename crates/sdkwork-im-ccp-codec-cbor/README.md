...
This README is the SDKWork module entrypoint for `sdkwork-im-ccp-codec-cbor`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
...
- `cargo test --manifest-path apps/sdkwork-im/crates/sdkwork-im-ccp-codec-cbor/Cargo.toml`
