# Craw Chat Ccp Binding Http Component Specs

This directory is the local standards index for `craw-chat-ccp-binding-http`.
...
| Field | Value |
| --- | --- |
| Name | `craw-chat-ccp-binding-http` |
| Type | `rust-crate` |
| Root | `craw-chat/crates/craw-chat-ccp-binding-http` |
...
- `cargo test --manifest-path apps/craw-chat/crates/craw-chat-ccp-binding-http/Cargo.toml`
