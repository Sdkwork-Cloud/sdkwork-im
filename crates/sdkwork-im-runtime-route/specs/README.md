# Sdkwork IM Runtime Route Component Specs

This directory is the local standards index for `sdkwork-im-runtime-route`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-im-runtime-route` |
| Type | `rust-crate` |
| Root | `sdkwork-im/crates/sdkwork-im-runtime-route` |
