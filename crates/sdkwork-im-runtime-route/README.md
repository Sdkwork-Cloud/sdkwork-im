...
This README is the SDKWork module entrypoint for `sdkwork-im-runtime-route`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
...
- `cargo test --manifest-path apps/sdkwork-im/crates/sdkwork-im-runtime-route/Cargo.toml`
