# Craw Chat Ccp Core Component Specs

This directory is the local standards index for `craw-chat-ccp-core`.
...
| Field | Value |
| --- | --- |
| Name | `craw-chat-ccp-core` |
| Type | `rust-crate` |
| Root | `craw-chat/crates/craw-chat-ccp-core` |
