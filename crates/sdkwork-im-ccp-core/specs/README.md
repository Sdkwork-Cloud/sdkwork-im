# Sdkwork IM Ccp Core Component Specs

This directory is the local standards index for `sdkwork-im-ccp-core`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-im-ccp-core` |
| Type | `rust-crate` |
| Root | `sdkwork-im/crates/sdkwork-im-ccp-core` |
