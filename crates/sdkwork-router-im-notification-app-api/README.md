# sdkwork-router-im-notification-app-api

## Purpose

HTTP route crate for SDKWork IM `app-api` surface at `/app/v3/api/notifications`.
...
```bash
cargo check -p sdkwork-router-im-notification-app-api
