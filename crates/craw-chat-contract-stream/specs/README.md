# Craw Chat Contract Stream Component Specs

This directory is the local standards index for `craw-chat-contract-stream`.
...
| Field | Value |
| --- | --- |
| Name | `craw-chat-contract-stream` |
| Type | `rust-crate` |
| Root | `craw-chat/crates/craw-chat-contract-stream` |
...
- `cargo test --manifest-path apps/craw-chat/crates/craw-chat-contract-stream/Cargo.toml`
