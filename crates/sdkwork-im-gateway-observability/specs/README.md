...
This directory is the local standards index for `sdkwork-im-gateway-observability`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-im-gateway-observability` |
| Type | `rust-crate` |
| Root | `sdkwork-im/crates/sdkwork-im-gateway-observability` |
