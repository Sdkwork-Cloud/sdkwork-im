# Sdkwork IM Contract Message Component Specs

This directory is the local standards index for `sdkwork-im-contract-message`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-im-contract-message` |
| Type | `rust-crate` |
| Root | `sdkwork-im/crates/sdkwork-im-contract-message` |
