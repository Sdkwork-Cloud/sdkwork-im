# Sdkwork IM Ccp Binding Http Component Specs

This directory is the local standards index for `sdkwork-im-ccp-binding-http`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-im-ccp-binding-http` |
| Type | `rust-crate` |
| Root | `sdkwork-im/crates/sdkwork-im-ccp-binding-http` |
