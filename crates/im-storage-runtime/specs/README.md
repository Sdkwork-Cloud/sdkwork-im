# Im Storage Runtime Component Specs

This directory is the local standards index for `im-storage-runtime`.
...
| Field | Value |
| --- | --- |
| Name | `im-storage-runtime` |
| Type | `rust-crate` |
| Root | `sdkwork-im/crates/im-storage-runtime` |
