# Sdkwork IM Openapi Component Specs

This directory is the local standards index for `sdkwork-im-openapi`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-im-openapi` |
| Type | `rust-crate` |
| Root | `sdkwork-im/crates/sdkwork-im-openapi` |
