# sdkwork-router-im-ops-backend-api

## Purpose

HTTP route crate for SDKWork IM `backend-api` surface at `/backend/v3/api/ops`.
...
```bash
cargo check -p sdkwork-router-im-ops-backend-api
