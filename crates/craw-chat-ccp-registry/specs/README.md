# Craw Chat Ccp Registry Component Specs

This directory is the local standards index for `craw-chat-ccp-registry`.
...
| Field | Value |
| --- | --- |
| Name | `craw-chat-ccp-registry` |
| Type | `rust-crate` |
| Root | `craw-chat/crates/craw-chat-ccp-registry` |
