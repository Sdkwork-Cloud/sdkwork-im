# Sdkwork IM Contract Core Component Specs

This directory is the local standards index for `sdkwork-im-contract-core`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-im-contract-core` |
| Type | `rust-crate` |
| Root | `sdkwork-im/crates/sdkwork-im-contract-core` |
