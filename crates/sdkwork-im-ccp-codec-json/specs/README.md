# Sdkwork IM Ccp Codec Json Component Specs

This directory is the local standards index for `sdkwork-im-ccp-codec-json`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-im-ccp-codec-json` |
| Type | `rust-crate` |
| Root | `sdkwork-im/crates/sdkwork-im-ccp-codec-json` |
