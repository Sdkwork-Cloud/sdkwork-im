# craw-chat-gateway-observability
...
This README is the SDKWork module entrypoint for `craw-chat-gateway-observability`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
...
- `cargo test --manifest-path apps/craw-chat/crates/craw-chat-gateway-observability/Cargo.toml`
