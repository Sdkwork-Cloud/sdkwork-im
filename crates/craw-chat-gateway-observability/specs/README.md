# Craw Chat Gateway Observability Component Specs

This directory is the local standards index for `craw-chat-gateway-observability`.
...
| Field | Value |
| --- | --- |
| Name | `craw-chat-gateway-observability` |
| Type | `rust-crate` |
| Root | `craw-chat/crates/craw-chat-gateway-observability` |
