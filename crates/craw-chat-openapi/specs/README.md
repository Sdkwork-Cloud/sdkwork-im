# Craw Chat Openapi Component Specs

This directory is the local standards index for `craw-chat-openapi`.
...
| Field | Value |
| --- | --- |
| Name | `craw-chat-openapi` |
| Type | `rust-crate` |
| Root | `craw-chat/crates/craw-chat-openapi` |
