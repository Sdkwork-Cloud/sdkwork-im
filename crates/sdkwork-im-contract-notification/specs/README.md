# Sdkwork IM Contract Notification Component Specs

This directory is the local standards index for `sdkwork-im-contract-notification`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-im-contract-notification` |
| Type | `rust-crate` |
| Root | `sdkwork-im/crates/sdkwork-im-contract-notification` |
