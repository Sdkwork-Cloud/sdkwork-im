# sdkwork-im-contract-notification
...
This README is the SDKWork module entrypoint for `sdkwork-im-contract-notification`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
...
- `cargo test --manifest-path apps/sdkwork-im/crates/sdkwork-im-contract-notification/Cargo.toml`
