# Sdkwork IM Ccp Binding Mqtt Component Specs

This directory is the local standards index for `sdkwork-im-ccp-binding-mqtt`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-im-ccp-binding-mqtt` |
| Type | `rust-crate` |
| Root | `sdkwork-im/crates/sdkwork-im-ccp-binding-mqtt` |
