# SDKWork API Config Component Specs

This directory is the local standards index for `sdkwork-api-config`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-api-config` |
| Type | `rust-crate` |
| Root | `sdkwork-im/crates/sdkwork-api-config` |
