# Craw Chat Contract Core Component Specs

This directory is the local standards index for `craw-chat-contract-core`.
...
| Field | Value |
| --- | --- |
| Name | `craw-chat-contract-core` |
| Type | `rust-crate` |
| Root | `craw-chat/crates/craw-chat-contract-core` |
