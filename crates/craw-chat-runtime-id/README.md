# craw-chat-runtime-id

Domain: communication
Capability: craw-chat-runtime-id
Package type: rust-crate
Status: standard

This README is the SDKWork module entrypoint for `craw-chat-runtime-id`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
