# sdkwork-routes-im-projection-open-api

## Purpose

HTTP route crate for SDKWork IM `open-api` surface at `/im/v3/api/chat`.
...
```bash
cargo check -p sdkwork-routes-im-projection-open-api
