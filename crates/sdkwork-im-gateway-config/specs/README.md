...
This directory is the local standards index for `sdkwork-im-gateway-config`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-im-gateway-config` |
| Type | `rust-crate` |
| Root | `sdkwork-im/crates/sdkwork-im-gateway-config` |
