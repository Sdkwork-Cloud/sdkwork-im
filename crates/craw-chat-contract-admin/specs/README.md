# Craw Chat Contract Admin Component Specs

This directory is the local standards index for `craw-chat-contract-admin`.
...
| Field | Value |
| --- | --- |
| Name | `craw-chat-contract-admin` |
| Type | `rust-crate` |
| Root | `craw-chat/crates/craw-chat-contract-admin` |
...
- `cargo test --manifest-path apps/craw-chat/crates/craw-chat-contract-admin/Cargo.toml`
