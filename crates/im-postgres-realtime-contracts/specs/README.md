# Im Postgres Realtime Contracts Component Specs

This directory is the local standards index for `im-postgres-realtime-contracts`.
...
| Field | Value |
| --- | --- |
| Name | `im-postgres-realtime-contracts` |
| Type | `rust-crate` |
| Root | `sdkwork-im/crates/im-postgres-realtime-contracts` |
