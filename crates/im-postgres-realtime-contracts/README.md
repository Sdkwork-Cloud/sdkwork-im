# im-postgres-realtime-contracts
...
This README is the SDKWork module entrypoint for `im-postgres-realtime-contracts`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
...
- `cargo test --manifest-path apps/sdkwork-im/crates/im-postgres-realtime-contracts/Cargo.toml`
