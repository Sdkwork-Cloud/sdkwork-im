# Sdkwork IM Contract Agent Component Specs

This directory is the local standards index for `sdkwork-im-contract-agent`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-im-contract-agent` |
| Type | `rust-crate` |
| Root | `sdkwork-im/crates/sdkwork-im-contract-agent` |
