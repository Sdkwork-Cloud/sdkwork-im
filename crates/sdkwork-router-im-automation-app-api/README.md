# sdkwork-router-im-automation-app-api

## Purpose

HTTP route crate for SDKWork IM `app-api` surface at `/app/v3/api/automation`.
...
```bash
cargo check -p sdkwork-router-im-automation-app-api
