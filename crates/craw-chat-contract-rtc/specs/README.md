# Craw Chat Contract Rtc Component Specs

This directory is the local standards index for `craw-chat-contract-rtc`.
...
| Field | Value |
| --- | --- |
| Name | `craw-chat-contract-rtc` |
| Type | `rust-crate` |
| Root | `craw-chat/crates/craw-chat-contract-rtc` |
...
- `cargo test --manifest-path apps/craw-chat/crates/craw-chat-contract-rtc/Cargo.toml`
