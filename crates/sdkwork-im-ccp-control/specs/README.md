# Sdkwork IM Ccp Control Component Specs

This directory is the local standards index for `sdkwork-im-ccp-control`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-im-ccp-control` |
| Type | `rust-crate` |
| Root | `sdkwork-im/crates/sdkwork-im-ccp-control` |
