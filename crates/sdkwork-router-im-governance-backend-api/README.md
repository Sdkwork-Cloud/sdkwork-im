# sdkwork-router-im-governance-backend-api

## Purpose

HTTP route crate for SDKWork IM `backend-api` surface at `/backend/v3/api/admin`.
...
```bash
cargo check -p sdkwork-router-im-governance-backend-api
