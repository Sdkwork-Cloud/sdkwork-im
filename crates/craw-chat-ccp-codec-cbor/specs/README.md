# Craw Chat Ccp Codec Cbor Component Specs

This directory is the local standards index for `craw-chat-ccp-codec-cbor`.
...
| Field | Value |
| --- | --- |
| Name | `craw-chat-ccp-codec-cbor` |
| Type | `rust-crate` |
| Root | `craw-chat/crates/craw-chat-ccp-codec-cbor` |
...
- `cargo test --manifest-path apps/craw-chat/crates/craw-chat-ccp-codec-cbor/Cargo.toml`
