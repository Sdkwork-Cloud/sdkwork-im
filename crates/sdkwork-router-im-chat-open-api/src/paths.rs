...
pub const ROOM: &str = "/im/v3/api/chat/rooms/{room_id}";
pub const ROOM_ENTER: &str = "/im/v3/api/chat/rooms/{room_id}/enter";
pub const ROOM_LEAVE: &str = "/im/v3/api/chat/rooms/{room_id}/leave";
