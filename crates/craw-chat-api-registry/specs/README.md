# Craw Chat API Registry Component Specs

This directory is the local standards index for `craw-chat-api-registry`.
...
| Field | Value |
| --- | --- |
| Name | `craw-chat-api-registry` |
| Type | `rust-crate` |
| Root | `craw-chat/crates/craw-chat-api-registry` |
