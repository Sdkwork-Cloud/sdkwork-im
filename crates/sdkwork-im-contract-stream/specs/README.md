# Sdkwork IM Contract Stream Component Specs

This directory is the local standards index for `sdkwork-im-contract-stream`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-im-contract-stream` |
| Type | `rust-crate` |
| Root | `sdkwork-im/crates/sdkwork-im-contract-stream` |
