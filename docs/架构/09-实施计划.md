...
- current state = evidence_collected_gate_passed for Capacity Tier.
...
- Capacity Tier now uses evidence_collected_gate_passed (doc-captured backfill; dedicated topology runs still pending).
