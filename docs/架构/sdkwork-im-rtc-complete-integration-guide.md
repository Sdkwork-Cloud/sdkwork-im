...
| RTC | `rtc_sdk` | `sdks/sdkwork-rtc-sdk/sdkwork-rtc-sdk-flutter` |
...
```bash
pnpm add file:../sdks/sdkwork-im-sdk/sdkwork-im-sdk-typescript
pnpm add file:../sdks/sdkwork-rtc-sdk/sdkwork-rtc-sdk-typescript
...
dependencies:
  rtc_sdk:
    path: ../sdks/sdkwork-rtc-sdk/sdkwork-rtc-sdk-flutter
  im_sdk:
    path: ../sdks/sdkwork-im-sdk/sdkwork-im-sdk-flutter/composed
...
node .\sdks\sdkwork-rtc-sdk\bin\sdk-call-smoke.mjs --json
node .\sdks\sdkwork-rtc-sdk\bin\sdk-call-smoke.mjs --language flutter --json
node .\sdks\sdkwork-rtc-sdk\bin\smoke-sdk.mjs
```
...
- `sdks/sdkwork-rtc-sdk/docs/usage-guide.md`
- `sdks/sdkwork-rtc-sdk/docs/typescript-volcengine-im-usage.md`
- `sdks/sdkwork-rtc-sdk/docs/flutter-volcengine-im-usage.md`
