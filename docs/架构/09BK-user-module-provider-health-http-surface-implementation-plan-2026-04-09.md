...
**Goal:** Expose user-module provider health over HTTP and freeze both healthy and unavailable contracts.
...
**Files:**
- Create: `services/local-minimal-node/tests/user_module_provider_http_test.rs`

- [ ] **Step 1: Write the failing tests**
- [ ] **Step 2: Run `cargo test -p local-minimal-node --offline --test user_module_provider_http_test -- --nocapture`**
...
- [ ] **Step 1: Add `AppState` user-module health accessor**
- [ ] **Step 2: Add `user_module` health handler**
- [ ] **Step 3: Register `/api/v1/user-module/provider-health`**
- [ ] **Step 4: Add minimal health details for local/external providers**

### Task 3: Remove env-test leakage

**Files:**
- Modify: `services/local-minimal-node/tests/user_module_provider_http_test.rs`
- Modify: `services/local-minimal-node/tests/user_module_provider_runtime_selection_test.rs`
