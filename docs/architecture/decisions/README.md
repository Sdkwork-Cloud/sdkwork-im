...
`ARCHITECTURE_DECISION_SPEC.md` ยง1):
...
| ADR | Title | Status |
| --- | --- | --- |
| [ADR-20260615-crate-naming-alignment](./ADR-20260615-crate-naming-alignment.md) | Crate naming alignment (`sdkwork-im-*`/`im-*` โ?`sdkwork-im-*`), batched migration | proposed |
