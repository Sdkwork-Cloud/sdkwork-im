> Migrated from `docs/superpowers/plans/2026-04-15-typescript-generated-package-install-safety.md` on 2026-06-24.
...
**Goal:** Make the generated TypeScript transport package install-safe so downstream package install (for example `pnpm install`) does not fail because the generated package runs stale local build hooks or broken `.bin` tool links.
