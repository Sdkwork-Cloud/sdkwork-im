> Migrated from `docs/release/2026-04-11-v0.0.79-loop-79.md` on 2026-06-24.
...
- `services/control-plane-api/src/lib.rs`
  ...
  - added runtime reclaim method and `POST /backend/v3/api/control/social/runtime/reclaim-stale-pending-shared-channel-sync`
