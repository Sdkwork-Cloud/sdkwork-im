> Migrated from `docs/sites/deployment/docker.md` on 2026-06-24.
...
Pre-topology-v2 minimal/default Compose profiles and their deploy wrapper scripts are removed. Do
not reference retired compose templates under `deployments/docker-compose/`.
