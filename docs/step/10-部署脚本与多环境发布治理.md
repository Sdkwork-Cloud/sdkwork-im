...
- 本地单机开发环境
- local-default / local-minimal profile
- Docker / Compose 启动
- 私有化与多环境配置模板
...
- 当前 local-minimal、local-default 的真实启动链路
...
- `local-minimal`：单机闭环验证
- `local-default`：更接近真实依赖的本地环境
...
- 新 profile 先以补充方式加入，避免覆盖已稳定的 local-minimal
