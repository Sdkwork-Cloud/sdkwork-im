...
## Actions This Loop
- actual_changes:
  - `control-plane-api` 新增 `PublicSharedChannelLinkedMemberSyncTrigger`，以 public bearer 身份把 ready-pair sync 请求投递到 standalone `conversation-runtime` 的 `POST /api/v1/conversations/shared-channel-links/sync`
