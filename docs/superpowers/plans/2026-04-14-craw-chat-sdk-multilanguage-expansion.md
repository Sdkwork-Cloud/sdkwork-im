# Craw Chat SDK Multilanguage Expansion Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Upgrade `sdks/sdkwork-craw-chat-sdk` into a production-grade three-language app SDK workspace for TypeScript, Flutter, and Rust, with a strict generated/manual ownership boundary and a professional Rust composed SDK layered above generated HTTP transport.

**Architecture:** Keep `generated/server-openapi` as the only generator-owned output in every language workspace. Extend the root Craw Chat SDK wrappers so they generate, normalize, verify, and assemble `typescript`, `flutter`, and `rust`, then add a manual-owned Rust `composed` crate that mirrors the existing TypeScript and Flutter consumer-facing `CrawChatClient + modules + builders` pattern without duplicating DTOs or HTTP transport.

**Tech Stack:** OpenAPI 3.0.3, Node.js SDK generator, PowerShell, POSIX shell, Rust/Cargo, TypeScript, existing Craw Chat SDK verification scripts
...
**Files:**
- Modify: `sdks/sdkwork-craw-chat-sdk/bin/verify-sdk-automation.mjs`
- Modify: `sdks/sdkwork-craw-chat-sdk/bin/verify-powershell-wrapper-args.mjs`
...
```js
expectReadmeToContain('- Rust: [sdkwork-craw-chat-sdk-rust]');
...
```bash
git add sdks/sdkwork-craw-chat-sdk/bin/verify-sdk-automation.mjs sdks/sdkwork-craw-chat-sdk/bin/verify-powershell-wrapper-args.mjs sdks/sdkwork-craw-chat-sdk/README.md
...
- Create: `sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/bin/sdk-assemble.ps1`
- Create: `sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/bin/sdk-assemble.sh`
- Create: `sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/Cargo.toml`
...
```js
requirePath('sdkwork-craw-chat-sdk-rust/README.md');
requirePath('sdkwork-craw-chat-sdk-rust/bin/sdk-gen.ps1');
requirePath('sdkwork-craw-chat-sdk-rust/composed/Cargo.toml');
```

- [ ] **Step 2: Run test to verify it fails**

Run: `node sdks/sdkwork-craw-chat-sdk/bin/verify-sdk-automation.mjs`
...
```bash
git add sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust
...
- Modify: `sdks/sdkwork-craw-chat-sdk/bin/verify-auth-surface-alignment.mjs`
- Test: `sdks/sdkwork-craw-chat-sdk/bin/generate-sdk.ps1`
- Test: `sdks/sdkwork-craw-chat-sdk/bin/generate-sdk.sh`
- Test: `sdks/sdkwork-craw-chat-sdk/bin/assemble-sdk.mjs`
- Test: `sdks/sdkwork-craw-chat-sdk/bin/verify-auth-surface-alignment.mjs`
...
```bash
node sdks/sdkwork-craw-chat-sdk/bin/verify-auth-surface-alignment.mjs --language rust
powershell -ExecutionPolicy Bypass -File sdks/sdkwork-craw-chat-sdk/bin/generate-sdk.ps1 -Languages rust
node sdks/sdkwork-craw-chat-sdk/bin/assemble-sdk.mjs --language rust
```
...
- generated manifest: `sdkwork-craw-chat-sdk-rust/generated/server-openapi/Cargo.toml`
- composed manifest: `sdkwork-craw-chat-sdk-rust/composed/Cargo.toml`
...
```bash
git add sdks/sdkwork-craw-chat-sdk/bin/generate-sdk.ps1 sdks/sdkwork-craw-chat-sdk/bin/generate-sdk.sh sdks/sdkwork-craw-chat-sdk/bin/normalize-generated-auth-surface.mjs sdks/sdkwork-craw-chat-sdk/bin/assemble-sdk.mjs sdks/sdkwork-craw-chat-sdk/bin/verify-auth-surface-alignment.mjs sdks/sdkwork-craw-chat-sdk/.sdkwork-assembly.json
...
**Files:**
- Create: `sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/tests/craw_chat_client_test.rs`
- Create: `sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/src/lib.rs`
- Create: `sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/src/client.rs`
- Create: `sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/src/context.rs`
- Create: `sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/src/types.rs`
- Create: `sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/src/error.rs`
- Test: `sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/tests/craw_chat_client_test.rs`

- [ ] **Step 1: Write the failing test**

Create focused core-client tests that lock the minimal Rust composed crate contract:

- `CrawChatClient::new(backend_client)` exists
- `CrawChatClient::new_with_base_url(base_url)` exists
...
use sdkwork_craw_chat_backend_sdk::SdkworkBackendClient;

#[test]
fn craw_chat_client_wraps_generated_backend_client() -> Result<(), Box<dyn std::error::Error>> {
    let backend = SdkworkBackendClient::new_with_base_url("http://127.0.0.1:18090")?;
    let sdk = CrawChatClient::new(backend.clone());
    sdk.set_auth_token("token");
    let _ = sdk.backend_client();
    Ok(())
}
...
```bash
cargo test --manifest-path sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/Cargo.toml craw_chat_client_wraps_generated_backend_client -- --exact
cargo test --manifest-path sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/Cargo.toml craw_chat_client_can_be_built_from_base_url -- --exact
```
...
- `Cargo.toml` package name: `craw-chat-sdk`
- lib crate name: `craw_chat_sdk`
...
```bash
git add sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/Cargo.toml sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/src sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/tests/craw_chat_client_test.rs
...
**Files:**
- Create: `sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/src/builders.rs`
- Create: `sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/src/session_module.rs`
- Create: `sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/src/presence_module.rs`
- Create: `sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/src/realtime_module.rs`
- Create: `sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/src/device_module.rs`
- Create: `sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/src/inbox_module.rs`
- Create: `sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/src/conversations_module.rs`
- Create: `sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/src/messages_module.rs`
- Create: `sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/src/media_module.rs`
- Create: `sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/src/streams_module.rs`
- Create: `sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/src/rtc_module.rs`
- Modify: `sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/src/client.rs`
- Modify: `sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/src/lib.rs`
- Modify: `sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/tests/craw_chat_client_test.rs`
- Test: `sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/tests/craw_chat_client_test.rs`
...
```bash
cargo test --manifest-path sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/Cargo.toml --test craw_chat_client_test
```
...
Run: `cargo test --manifest-path sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/Cargo.toml --test craw_chat_client_test`
...
```bash
git add sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/src sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/tests/craw_chat_client_test.rs
...
- Create: `sdks/sdkwork-craw-chat-sdk/bin/verify-rust-package-metadata.mjs`
- Create: `sdks/sdkwork-craw-chat-sdk/bin/verify-rust-public-api-boundary.mjs`
...
- Modify: `sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/README.md`
- Test: `sdks/sdkwork-craw-chat-sdk/bin/verify-rust-workspace.mjs`
...
```bash
node sdks/sdkwork-craw-chat-sdk/bin/verify-rust-workspace.mjs
...
```bash
git add sdks/sdkwork-craw-chat-sdk/bin/verify-rust-workspace.mjs sdks/sdkwork-craw-chat-sdk/bin/verify-rust-package-metadata.mjs sdks/sdkwork-craw-chat-sdk/bin/verify-rust-public-api-boundary.mjs sdks/sdkwork-craw-chat-sdk/bin/verify-sdk.mjs sdks/sdkwork-craw-chat-sdk/bin/verify-sdk.ps1 sdks/sdkwork-craw-chat-sdk/bin/verify-sdk.sh sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/README.md
...
- Modify: `sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/README.md`
- Modify: `sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/README.md`
- Test: `sdks/sdkwork-craw-chat-sdk/bin/verify-sdk-automation.mjs`
...
```bash
git add sdks/sdkwork-craw-chat-sdk/README.md sdks/sdkwork-craw-chat-sdk/.sdkwork-assembly.json sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-typescript/README.md sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-flutter/README.md sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/README.md sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/README.md
...
**Files:**
- Modify: `docs/superpowers/specs/2026-04-14-craw-chat-sdk-multilanguage-expansion-design.md`
- Modify: `docs/superpowers/plans/2026-04-14-craw-chat-sdk-multilanguage-expansion.md`
...
node sdks/sdkwork-craw-chat-sdk/bin/verify-auth-surface-alignment.mjs --language rust
node sdks/sdkwork-craw-chat-sdk/bin/verify-rust-workspace.mjs
cargo test --manifest-path sdks/sdkwork-craw-chat-sdk/sdkwork-craw-chat-sdk-rust/composed/Cargo.toml
```
...
```powershell
powershell -ExecutionPolicy Bypass -File sdks/sdkwork-craw-chat-sdk/bin/generate-sdk.ps1 -Languages typescript,flutter,rust
```
...
```bash
node sdks/sdkwork-craw-chat-sdk/bin/verify-sdk.mjs --language typescript --language flutter --language rust
```
...
```bash
git add docs/superpowers/specs/2026-04-14-craw-chat-sdk-multilanguage-expansion-design.md docs/superpowers/plans/2026-04-14-craw-chat-sdk-multilanguage-expansion.md
