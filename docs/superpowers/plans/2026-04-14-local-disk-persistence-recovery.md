...
```powershell
$env:CARGO_TARGET_DIR='D:\javasource\spring-ai-plus\spring-ai-plus-business\apps\craw-chat\target\tdd-local-disk-red'; cargo test -p im-adapters-local-disk pending_tmp -- --nocapture
```
...
```powershell
$env:CARGO_TARGET_DIR='D:\javasource\spring-ai-plus\spring-ai-plus-business\apps\craw-chat\target\tdd-local-disk-green'; cargo test -p im-adapters-local-disk pending_tmp -- --nocapture
```
...
```powershell
$env:CARGO_TARGET_DIR='D:\javasource\spring-ai-plus\spring-ai-plus-business\apps\craw-chat\target\verify-local-disk'; cargo test -p im-adapters-local-disk
```
...
```powershell
$env:CARGO_TARGET_DIR='D:\javasource\spring-ai-plus\spring-ai-plus-business\apps\craw-chat\target\verify-local-disk-restart'; cargo test -p local-minimal-node --test real_auth_restart_e2e_test
$env:CARGO_TARGET_DIR='D:\javasource\spring-ai-plus\spring-ai-plus-business\apps\craw-chat\target\verify-local-disk-auth'; cargo test -p local-minimal-node --test real_auth_e2e_test
```
