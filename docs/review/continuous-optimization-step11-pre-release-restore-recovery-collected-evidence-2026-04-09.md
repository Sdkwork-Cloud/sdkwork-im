...
```powershell
cargo test -p local-minimal-node --offline --test performance_drill_catalog_test test_continuous_optimization_materializes_pre_release_restore_recovery_collected_evidence -- --exact --nocapture
```
