...
```powershell
cargo test -p sdkwork-im-gateway --offline --test performance_drill_catalog_test test_continuous_optimization_materializes_pre_release_upgrade_rollback_collected_evidence -- --exact --nocapture
```
