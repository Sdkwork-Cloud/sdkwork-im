...
- `$env:CARGO_TARGET_DIR='C:\Users\admin\.codex\memories\target-rtc-surface-local'; cargo test -p sdkwork-im-gateway --offline --test http_e2e_test test_local_minimal_profile_issues_rtc_participant_credential_over_http -- --nocapture`
- `$env:CARGO_TARGET_DIR='C:\Users\admin\.codex\memories\target-rtc-surface-local'; cargo test -p sdkwork-im-gateway --offline --test http_e2e_test test_local_minimal_profile_gets_rtc_provider_health_over_http -- --nocapture`
- `$env:CARGO_TARGET_DIR='C:\Users\admin\.codex\memories\target-rtc-surface-local'; cargo test -p sdkwork-im-gateway --offline --test rtc_runtime_persistence_test -- --nocapture`
- `$env:CARGO_TARGET_DIR='C:\Users\admin\.codex\memories\target-rtc-surface-local'; cargo test -p sdkwork-im-gateway --offline --test provider_plugin_docs_test -- --nocapture`
