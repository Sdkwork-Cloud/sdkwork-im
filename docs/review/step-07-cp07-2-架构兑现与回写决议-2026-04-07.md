...
- `docs/架构/148-CCP控制面注册表与协议发布治理设计-2026-04-06.md` 追加 `As-Built 2`
- `docs/架构/149-多Cell多Region协议升级与灾备兼容设计-2026-04-06.md` 追加 `As-Built 2`
