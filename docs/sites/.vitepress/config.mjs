  ...
  "/sdk/": [
    {
      ...
      items: [
        ...
        { text: "Admin SDK", link: "/sdk/control-plane-sdk" },
        { text: "Control-Plane TypeScript SDK", link: "/sdk/control-plane-typescript-sdk" },
        { text: "Control-Plane Flutter SDK", link: "/sdk/control-plane-flutter-sdk" },
