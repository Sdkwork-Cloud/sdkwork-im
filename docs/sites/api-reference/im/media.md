...
<div class="api-link-list">
  <a href="/api-reference/im/messages"><code>Messages</code> Media attachment targets are conversation messages documented on a separate page</a>
...
<div class="api-op-header">
  ...
  <code>/im/v3/api/media/uploads</code>
...
## `POST /im/v3/api/media/uploads/{mediaAssetId}/complete`

<div class="api-op-header">
  <span class="endpoint-tag endpoint-post">POST</span>
  <code>/im/v3/api/media/uploads/{mediaAssetId}/complete</code>
...
## `GET /im/v3/api/media/{mediaAssetId}`

<div class="api-op-header">
  <span class="endpoint-tag endpoint-get">GET</span>
  <code>/im/v3/api/media/{mediaAssetId}</code>
