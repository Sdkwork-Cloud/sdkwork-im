...
<p class="api-page-intro">
  Exact request and response contract for <strong>Messages</strong> in the <strong>App API</strong>.
</p>

<div class="api-link-list">
  <a href="/api-reference/app/messages"><code>Messages</code> Return to the group page for workflow context and related operations</a>
