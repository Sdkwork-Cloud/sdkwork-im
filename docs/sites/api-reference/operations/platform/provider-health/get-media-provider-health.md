...
<p class="api-page-intro">
  Exact request and response contract for <strong>Provider Health</strong> in the <strong>Platform API</strong>.
</p>

<div class="api-link-list">
  <a href="/api-reference/platform/provider-health"><code>Provider Health</code> Return to the group page for workflow context and related operations</a>
...
<div class="api-meta-grid">
  ...
  <div class="api-meta-card"><strong>SDK</strong><span>`sdkwork-craw-chat-sdk` / provider-health</span></div>
